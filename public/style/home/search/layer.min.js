...
! function(window, undefined) {
    ...
    Class.pt.creat = function() {
        ...
        switch (config.type) {
            case 0:
                config.title || (config.area = ['384px', '125px']);
    ...
    Class.pt.set = function(times) {
        ...
        if (config.title) {
            ...
            config.type !== 4 && layerE.find('.xubox_close').addClass('xubox_close0');
        };
        layerE.attr({
            ...
            case 0:
                ...
                if (config.title) {
                    layerE.find(doms[3]).css({
                        paddingTop: 50 + layerTitle.outerHeight()
                    });
                } else {
                    if (config.dialog.type === 7) {
    ...
    ready.run = function() {
        ...
        win = $(window);
        doms.html = $('html');
        layer.use(window.location.protocol + '//ssl1.tuniucdn.com/f/20141229/ui-lib/layer/skin/layer.css');
