...
;;var basicMenuEvent={init:function(){this.changeHeaderPhone();this.clickKeywordInput();},getPhoneCookie:function(objName){var arrStr=document.cookie.split("; ");for(var i=0;i<arrStr.length;i++){var temp=arrStr[i].split("=");if(temp[0]==objName)return unescape(temp[1]);}
return false;},changeHeaderPhone:function(){var _=this;var $phoneText=$(".J_PhoneText");var $phoneTel=$(".J_PhoneTel");var phoneCookie=_.getPhoneCookie("p_phone_400");if(phoneCookie&&phoneCookie=="1597-636-2499"){$phoneText.text("途致贵宾专线");$phoneTel.text("4007-979797");}else{$phoneText.text("客户服务电话");$phoneTel.text("1597-636-2499");}},clickKeywordInput:function(){var $input=$(".J_Keyword");var $parent=$input.parents(".J_SearchBox").eq(0);$input.bind({focus:function(){$parent.addClass("open");},blur:function(){setTimeout('$(".J_SearchBox").removeClass("open")',400);}});}}
$(function(){basicMenuEvent.init();})
function showHeadTuniuChat(data){$('.J_basicRight').append('<a class="basic-kefu" href="javascript:;" onclick="javascript:window.open(\''+data.url+'\', \''+data.label+'\', \''+data.winConfig+'\');">'+'欢迎使用<i>在线客服</i>'+'</a>');}
