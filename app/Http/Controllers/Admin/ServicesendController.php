...
class ServicesendController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $list = Servicelist::where('level','like',"%$level%")->where('status','=','0')->paginate(5);
        $num = Servicelist::count();

        return view('admin.servicesend.index',['list'=>$list,'num'=>$num]); 
    }
