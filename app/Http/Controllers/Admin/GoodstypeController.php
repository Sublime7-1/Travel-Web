...
class GoodstypeController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $type = \DB::table('level_types')->where('pid',0)->paginate(5);
        return view('admin.goodstype.index',['type'=>$type]);
    }
    ...
    public function check(Request $request){
        $pid = $request->route('pid');
       $type = \DB::table('level_types')->where('pid',$pid)->paginate(5);
        return view('admin.leveltype.index',['type'=>$type]);
    }
    //分屏数据
    public function x_index(){
        return view('admin.goodstype.x_index');
    }
