        ...
        <div class="header_box">
            ...
            <div class="left oh">
                <div class="right pull-right header-summary-satisfy">
                    <dl class="clearfix">
                        <dt class="eva_num">
                            <em>已有<?php echo e($comment_total); ?>人点评，</em>
                        </dt>
                        <dt class="pull-left">满意度:
                        </dt>
                        <dd class="pull-right value" id="sat_value">
                            <span><?php echo e($satisfied); ?>%</span>
                        </dd>
                    </dl>
                </div>
                <h1 class="header-order-name" id="gid" title="<?php echo e($goodsinfo->id); ?>"><?php echo e($goodsinfo->title); ?></h1>
                <p class="header-order-detail">
                    <span>订单编号:
                        <em class="high-light" id="oid" data='<?php echo e($orderinfo->id); ?>'><?php echo e($orderinfo->order_num); ?></em>
                    </span>
            ...
            <dl class="noborder travel-type" id="travelType" style="overflow: hidden">
                ...
                <div id="evaluation_box">
                    <dd class="travel_type">
                        <em>出游类型：</em>
                        <?php $__currentLoopData = $commenttype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span value="<?php echo e($v->id); ?>" title="<?php echo e($v->name); ?>"><?php echo e($v->name); ?></span>
                    ...
                    <dl class="clearfix uploadImg upload-img">
                        ...
                        <dd class="pic_frame" style="height: 100px;">
                            ...
                            <input type="text" name="addimg" id="addimg" value="">
    ...
    <script>
        ...
        $(function() { 
            ...
            $('#file_upload').uploadify({
                'swf'      : "<?php echo e(asset('/uploadify/uploadify.swf')); ?>",
                'buttonText':'图片上传',
                ...
                'uploader' : "<?php echo e(url('/home/ajax_upload')); ?>",//定义自己的上传文件的方法
        ...
        // alert($('#div').html());
        $(function(){
            var ss = "<?php echo e(session('userid')); ?>";
            if(ss == ''){
                location.href = '/login';
            }
        });
        ...
        $('#do_commit').click(function(){
            ...
            $.post('/home/comment',{'data':datas,'_token':"<?php echo e(csrf_token()); ?>"},function(res){
                console.log(res);
                if(res == 1){
                    //提交成功弹出层
                    $("#SuccessJump").show();
