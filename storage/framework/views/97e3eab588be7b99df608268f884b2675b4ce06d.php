...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       ...
       <span class="r_f">共：<b><?php echo e($total); ?> </b>位</span>
     </div>
      ...
      <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($v->business); ?></td>
                <td><?php echo e($v->phone); ?></td>
                <td><?php echo e($v->email); ?></td>
                <td>
                     <a title="编辑" href="javascript:;" value="<?php echo e($v->id); ?>" class="btn btn-xs btn-info r_edit" ><i class="fa fa-edit bigger-120"></i></a>        
                     <a title="删除" href="javascript:;"  onclick="r_del(this,'<?php echo e($v->id); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                </td>
            </tr> 
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                   
          </tbody>
...
function r_del(obj,id){
  layer.confirm('确认要删除吗？',function(index){
        $.post("/admin/links_contacts/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
