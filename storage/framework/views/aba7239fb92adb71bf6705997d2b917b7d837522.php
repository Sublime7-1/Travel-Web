                                ...
                                <div class="pay-select mask_box">
                                    ...
                                    <div class="pay-select-con">
                                        <ul class="pl-wrap kj-box clearfix">
                                            <?php $__currentLoopData = $pay_quickly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="pl-item" style="display: list-item;">
                                                <span  class="bank-logo bank-icbc" cd="CBC" style="display:none" ct="3" ccm="23-3" dcm="75-3" cpdl="50000-5000" dpdl="50000-50000"><?php echo e($v->name); ?></span>
                                                <img style="width:115px;height:35px;margin-left:39px" src="<?php echo e($v->img); ?>" />
                                                <div class="tips">
                                                    <div class="bg"></div>
                                                    <b>支付超限，请选择其他银行卡</b>
                                                </div>
                    ...
                    <div class="pay-other">
                        ...
                        <div class="pay-other-con hasBind_field active">
                            <ul class="pay-other-list clearfix">
                                <?php $__currentLoopData = $pay_zfb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <a href="javascript:accountpaySubmit(9,16)" m="点击_支付平台_支付宝" class="hidden">
                                        <div class="tips one-line">
                                            <i class="z">◆</i>
                                            <i class="y">◆</i>
                                            <em><img src="<?php echo e($v->img); ?>" alt=""><?php echo e($v->name); ?>快捷支付限额较低，建议您直接使用<strong>途牛钱包或银行卡</strong>完成付款</em>
                                        </div>    
                                             <img src="<?php echo e($v->img); ?>" onclick="tiao()"  style="width:94px;height:35px;margin-left:39px" />                   
                                    </a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <script>
                                    function tiao(){
                                        location.href='/home/personal/index/doing_pay/<?php echo e($order_id); ?>';
                                    }
                                </script>
                            </ul>
                        </div>
