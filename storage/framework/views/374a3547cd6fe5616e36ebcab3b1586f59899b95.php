   ...
   <div class="dd_search"> 
    <div class="d_search"> 
      <form id="yjsearch_form" method="get" action="/home/article/total"> 
        <input class="input_search J_input" type="text" name="search" placeholder="搜索游记" value="<?php echo e($request->search); ?>" autocomplete="off" /> 
  ...
  <div class="yj-content"> 
    ...
    <div class="yj-list-show"> 
        ...
        <ul class="yj-list" style="display: block;">
            <?php if(count($article_total)): ?>
            <?php $__currentLoopData = $article_total; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <li> 
                <a class="list-img" target="_blank" rel="nofollow" href="/home/article/index/<?php echo e($v->id); ?>"> 
                    <img src="<?php echo e($v->thumb); ?>" alt="" /> 
                    <div class="list-recommend gl-jh" style="background-position: -100px 0px;"></div> 
                </a> 
                <div class="list-show"> 
                    <a target="_blank" rel="nofollow" href="/home/article/index/<?php echo e($v->id); ?>"> 
                        <div class="list-name"><?php echo e($v->title); ?></div> 
                        <div class="list-des"><?php echo $v->content; ?></div> 
                    </a> 
                    <div class="list-auther"> 
                        <div class="list-auther-left"> 
                            <a target="_blank" rel="nofollow" href="/home/article/index/<?php echo e($v->id); ?>"> 
                               ...
                               <div class="list-auther-name">来源 : <?php echo e($v->source); ?></div> 
                            </a> 
                            <div class="list-scan">
                               <i></i>999+ &nbsp;
                            </div>  
    ...
    <div class="pager pagination" data-init="pager" style="display: block;" data-pager-inited="true" data-curpage="1">
        <div style="margin:0 auto;text-align:center;height: 100px" id="list"><?php echo e($article_total->links()); ?></div>
    </div> 
