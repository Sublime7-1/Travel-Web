            ...
            <div class="focus-A">
                ...
                <div class="detail">
                    <div class="title_1" style="width: 6%;">
                        <input type="checkbox" product-type="" collect-id="<?php echo e($goods_v->collect_id); ?>" name="productInfo" class="choose-btn">
                    </div>
                    <div class="title_2" style="width: 64%;">
                        <a href="/home/goodsinfo/<?php echo e($goods_v->id); ?>" target="_blank"><img src="<?php echo e($goods_v->pic); ?>" alt="" title=""></a>
                        <p class="start-city ">出发</p>
                        <p class="focus-name">
                            <a href=/home/goodsinfo/<?php echo e($goods_v->id); ?> target="_blank"><?php echo e($goods_v->title); ?></a>
                        </p>
                        <p class="open-time">&nbsp;</p>
                        <p class="tour-type">
                            <span class="">
                    ...
                    <div class="title_3">
                        <p><span>￥</span><?php echo e($goods_v->price); ?><span>&nbsp;起</span></p>
                    </div>
                    <div class="title_4">
                        <a href="/home/goodsinfo/<?php echo e($goods_v->id); ?>" target="_blank" class="order-btn">预订</a>
                        <p class="del-btn" product-id="<?php echo e($goods_v->id); ?>" product-type="">删除</p>
                    </div>
                </div>
...
<script>
    ...
    $('.del-batch-btn').click(function(){
        ...
        if(ids == ''){
            ...
            // 删除该产品
            $.post('/home/collect/'+ids,{'_token':'<?php echo e(csrf_token()); ?>','_method':'DELETE'},function(data){
                if(data == 1){
