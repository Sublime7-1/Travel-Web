 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <button onclick="member_edit('编辑','/admin/NavigateSecadd/<?php echo e($id); ?>','4','','510')" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加分类</button>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <tr>
        ...
        <?php if(is_file('.'.$v->pic)): ?>
            <img src="<?php echo e($v->pic); ?>" alt="<?php echo e($v->name); ?>"  width="100px" name="pic" />
        <?php else: ?>
        无
        <?php endif; ?>
        </td>
       ...
       <td class="td-manage"><?php echo e($v->is_popular_game); ?></td>
       <td class="td-manage">
