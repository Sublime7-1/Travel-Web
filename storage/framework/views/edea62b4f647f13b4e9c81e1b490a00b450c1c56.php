 ...
 <div id="products_style">
    <div class="search_style">
     <form action="/admin/insurance">
      <ul class="search_content clearfix">
       <li><label class="l_f">保险名称</label><input name="keyword" type="text"  value="<?php echo e(isset($request->name) ? $request->name : ''); ?>" class="text_add" placeholder="输入保险名称"  style=" width:250px"/></li>
       <li style="width:90px;">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <tr>
        ...
        <td width="80px"><?php echo e($i++); ?></td>               
        <td width="250px"><?php echo e($v->name); ?></td>
        <td width="80px"><?php echo e($v->money); ?></td>
        <td width="80px"><?php echo e($v->type); ?></td>
        <td class="td-manage">
        <a title="编辑" onclick="member_edit(<?php echo e($v->id); ?>)" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
<?php if(session('insurance_msg')): ?>
<script>layer.msg('<?php echo e(session("insurance_msg")); ?>',{icon: '<?php echo e(session("tips_code")); ?>',time:1000});</script>
<?php endif; ?>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      $.post("/admin/insurance/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
