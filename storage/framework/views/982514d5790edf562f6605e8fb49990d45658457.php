  ...
  <div class=" clearfix" id="advertising"> 
     ...
     <div class="side_list"> 
      ...
      <div class="widget-body"> 
       <ul class="b_P_Sort_list"> 
        <li><i class="orange  fa fa-university"></i><a href="/admin/advert">全部 ( <?php echo e($total); ?> )</a></li> 
        ...
        <li><i class="fa fa-image pink "></i> <a href="/admin/advert?id=<?php echo e($v->id); ?>"><?php echo e($v->name); ?></a> ( <?php echo e($v->num); ?> )</li> 
   ...
   <div class="Ads_list"> 
    <div class="border clearfix"> 
     ...
     <span class="r_f">共：<b><?php echo e($total); ?></b>条广告</span> 
    </div> 
    <!-- 验证消息 -->
     ...
     <table class="table table-striped table-bordered table-hover" id="sample-table"> 
      ...
      <tbody> 
       ...
       <tr> 
        ...
        <td><?php echo e($i++); ?></td> 
        <td>
        	<input name="" readonly type="text" style=" width:50px" placeholder="<?php echo e($v->sort); ?>" />
        	<!-- <span class="cont_style"> 
	     	<select class="form-control" id="form-field-select-1" name="sort"> 
	     		<option value="0">选择分类</option> 
       			<?php $__currentLoopData = $v->sorts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	     		<option value="<?php echo e($vv); ?>" <?php if($v->sort == $vv): ?> selected <?php endif; ?>><?php echo e($vv); ?></option>
	     		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	     	</select>
	    </span>  -->
        </td> 
        <td><?php echo e($v->name); ?></td> 
        <td><span class="ad_img"><?php if($v->img != '0'): ?><img src="<?php echo e($v->img); ?>" width="100%" height="100%" /><?php else: ?>无<?php endif; ?></span></td> 
        <td><?php echo e($v->area); ?></td> 
        <td><?php echo e($v->addtime); ?></td> 
        <td><?php echo e($v->uptime); ?></td>  
        <td class="td-status">
        	<?php if($v->status == '显示'): ?>
        ...
        <td class="td-manage"> 
            ...
            <?php endif; ?> 
        	<a title="编辑"  value="<?php echo e($v->id); ?>" href="javascript:;" class="btn btn-xs btn-info ads_edit"><i class="fa fa-edit bigger-120"></i></a> 
        	<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo e($v->id); ?>')" class="btn btn-xs btn-warning"><i class="fa fa-trash  bigger-120"></i></a> </td> 
       </tr> 
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </tbody> 
     </table> 
