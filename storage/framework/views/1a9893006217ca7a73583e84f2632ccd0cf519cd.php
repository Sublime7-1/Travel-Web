 ...
 <div class="sort_style">
      ...
      <form action="/admin/comment" method="get">
        ...
        <ul class="search_content clearfix"> 
         <li><label class="l_f">评论者名称 :</label><input name="uname" type="text" class="text_add" placeholder="  输入评论者名称..." value="<?php echo e(isset($request->uname) ? $request->uname : ''); ?>" style=" width:200px;height: 36px"></li> 
    ...
    <table class="table table-striped table-bordered table-hover" id="sample-table">
		...
		<tbody>
	      ...
	      <tr>
	       ...
	       <td><?php echo e($v->colligate_grade); ?></td>
	       <td><?php echo e($v->discount_grade); ?></td>
	       <td><?php echo e($v->service_grade); ?></td>
	       <td><?php echo e($v->experience_grade); ?></td>
	       <td class="td-manage">
	         <a title="查看" href="javascript:;" onclick="member_see('<?php echo e($v->uname); ?>','<?php echo e($v->id); ?>')" class="btn btn-xs btn-info" >点击查看</a>   
	       </td>
	       <td><?php echo e($v->anonymous); ?></td>
	       <td class="td-status">
	        	<?php if($v->status == '未回复'): ?>
	        		<span class="label label-success radius"><?php echo e($v->status); ?></span>
		        <?php elseif($v->status == '已查看'): ?>
