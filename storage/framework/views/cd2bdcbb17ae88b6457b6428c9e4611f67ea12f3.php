...
<div class="page-content clearfix">
    ...
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        ...
        <a href="/admin/user" class="btn btn-info">返回会员列表</a>
       </span>
    ...
    <tbody>
        <?php $__currentLoopData = $useraddress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          <td><?php echo e($value->id); ?></td>
          <td><?php echo e($value->receiver); ?></td>
