...
<div class="add_menber" id="add_menber_style" style="border:1px solid #b0b0b0" >
    <form action="/admin/user/<?php echo e($user->id); ?>" method="post" id="submit1">
...
<?php endif; ?>
       <li><label class="label_name">用&nbsp;&nbsp;户 &nbsp;名：</label><span class="add_name"><input value="<?php echo e($user->username); ?>" name="username" top="用户名" type="text" datatype="*2-16" nullmsg="用户名不能为空" class="text_add"/></span><div class="prompt r_f"></div></li>
       ...
       <label><input name="sex" type="radio" <?php echo e($user->sex == 0 ? 'checked' : ''); ?> class="ace" value="0"><span class="lbl">男</span></label>&nbsp;&nbsp;&nbsp;
       <label><input name="sex" type="radio" <?php echo e($user->sex == 1 ? 'checked' : ''); ?> class="ace" value="1"><span class="lbl" >女</span></label>&nbsp;&nbsp;&nbsp;
       <label><input name="sex" type="radio" <?php echo e($user->sex == 2 ? 'checked' : ''); ?> class="ace" value="2"><span class="lbl" >保密</span></label>
       </span>
       ...
       <li><label class="label_name">移动电话：</label><span class="add_name"><input name="tel" top="移动电话" type="text"  value="<?php echo e($user->tel); ?>" class="text_add"/></span><div class="prompt r_f"></div></li>
       <li><label class="label_name">电子邮箱：</label><span class="add_name"><input name="email" top="email" type="text" value="<?php echo e($user->email); ?>" class="text_add"/></span><div class="prompt r_f"></div></li>
    
       <li><label class="label_name">状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span class="add_name">
       <label><input name="display" type="radio"  value="0" <?php echo e($user->display == 0 ? 'checked' : ''); ?> checked="checked" class="ace"><span class="lbl">开启</span></label>&nbsp;&nbsp;&nbsp;
       <label><input name="display"type="radio" value="1" <?php echo e($user->display == 1 ? 'checked' : ''); ?> class="ace"><span class="lbl">关闭</span></label></span><div class="prompt r_f"></div></li>
       <br>
