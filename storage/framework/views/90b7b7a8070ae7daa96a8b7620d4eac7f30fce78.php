...
<?php $__env->startSection('title','站内信'); ?>
    ...
    <div id="tabChangeBox" class="common_div messageBox"> 
	    ...
	    <div class="messageBox_item tabChangeCon hide" style="display: block;"> 
	     ...
	     <?php if($sinfo): ?>
	     	...
	     	<?php $__currentLoopData = $sinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	     		<tr>
	     			<td style="width: 175px;text-align: center;"><?php echo e($v->aname); ?></td>
	     			<td style="width: 170px;text-align: center"><?php echo e($v->title); ?></td>
	     			<td style="text-align: center;width: 450px"><?php echo $v->content; ?></td>	     			
	     			<td style="width: 200px;text-align: center"><?php echo e($v->time); ?></td>
	     			<td style="width: 160px;text-align: center">
	     				<button onclick="mem_del(this,<?php echo e($v->id); ?>)" style="width: 80px;color:white;height: 30px;background:red;border-radius: 10px">删除</button>
	     			</td>
	     		</tr>
	     ...
	     <!-- <div class="pagination clearfx" id="msgoutpages" data-curpage="1" data-pager-inited="true"> -->
	      	<div style="margin:0 auto;text-align:center;height: 100px" id="list"><?php echo e($sinfo->links()); ?></div>
	     </div> 
	    <!-- </div>  -->
	    <!--收件箱E-->
	    <!--发件箱S-->     	
