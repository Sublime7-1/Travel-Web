...
<div class=" page-content clearfix">
 <div id="products_style">
    <div class="search_style">
     <form action="/admin/NavigateFirst/<?php echo e($pid); ?>" method="get">
      <ul class="search_content clearfix">
       <li><label class="l_f">产品名称</label><input name="keyword" value="<?php echo e(isset($keyword) ? $keyword : ''); ?>" type="text"  class="text_add" placeholder="输入品牌名称"  style=" width:250px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
        <button onclick="member_edit('编辑','/admin/NavigateFirst/create','4','','510')" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加分类</button>
        ...
        <a href="/admin/NavigateFirst" class="btn btn-info"><i class="icon-trash"></i>查看层数分类</a>
       </span>
       <span class="r_f">共：<b><?php echo e($num); ?></b>个子分类</span>
     </div>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <tr>
        ...
        <td width="100px">
            <?php if($v->pic): ?>
            <img src="../<?php echo e($v->pic); ?>" alt="<?php echo e($v->name); ?>"  name="pic" />
            <?php else: ?>
            无
            <?php endif; ?>
        </td>
        <td class="td-manage"><?php echo e($v->pid); ?></td>
       <td class="td-manage"><?php echo e($v->path); ?></td>
       <td class="td-manage"><?php echo $v->is_display; ?></td>
        <td class="td-manage">
            <a title="编辑" onclick="member_edit('编辑','/admin/NavigateFirst/<?php echo e($v->id); ?>/edit','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      $.post("/admin/NavigateFirst/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
...
function changeStatus(obj){
    ...
    $.get('/admin/chan_navigate_status/'+id,{'status':sta_val},function(data){
           if (data == 1) {
                if (sta_val == 1) {
