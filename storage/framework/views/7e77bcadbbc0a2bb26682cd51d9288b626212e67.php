...
<div class="Competence_add_style clearfix">
  ...
  <?php if(count($errors) > 0): ?>
   ...
   <div class="title_name">添加权限</div>
    ...
    <form action='/admin/level' method="post" id="submit2" >

     <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限名称 </label>
       <div class="col-sm-9"><input type="text" id="form-field-1" placeholder="" top="权限名称"  name="username" class="col-xs-10 col-sm-5 top"></div>
    </div>
     <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限描述 </label>
      <div class="col-sm-9"><textarea name="desc" class="form-control" id="form_textarea" placeholder="" onkeyup="checkLength(this);">请输入描述</textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div>
    </div>
    <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 用户选择 </label>
       ...
       <label class="middle"><input class="ace top" top="用户选择" checked type="radio" name="userid" value="<?php echo e($value->id); ?>" id="id-disable-check"><span class="lbl"> <?php echo e($value->name); ?></span></label>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>   
   </div>
   ...
   <div class="Button_operation">
        ...
        <a  href="/admin/level" onclick="article_save();" class="btn btn-secondary  btn-warning" type="button"><i class="fa fa-reply"></i> 返回上一步</a>
   ...
   <div class="Assign_style">
      ...
      <dl class="permission-list">
        <dt><label class="middle"><input  class="ace top1" type="checkbox" name="ids[]" value="<?php echo e($value->ac); ?>" id="id-disable-check"><span class="lbl"><?php echo e($value->typename); ?></span></label></dt>
        <dd>
            ...
            <?php if($val->pid == $value->id): ?>
             ...
             <dt><label class="middle"><input type="checkbox" value="<?php echo e($val->ac); ?>" checked class="ace top1"  name="ids[]" id="id-disable-check"><span class="lbl"><?php echo e($val->typename); ?></span></label></dt>
                <dd>
                ...
                <?php if($v->pid == $val->id): ?>
                   ...
                   <label class="middle"><input type="checkbox" value="<?php echo e($val->ac); ?><?php echo e($v->ac); ?>" class="ace top1" name="ids[]" id="<?php echo e($v->id); ?>"><span class="lbl"><?php echo e($v->typename); ?></span></label>
