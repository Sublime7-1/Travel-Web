...
<div class="margin clearfix">
 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
      <form action="/admin/goodsinfo/city/<?php echo e($goods_id); ?>" method="post" id="formtip">
        <input type="hidden" name="goods_id" value="<?php echo e($goods_id); ?>" />
        <input type="hidden" name="_method" value="PUT" />
        <?php echo e(csrf_field()); ?>

       <ul>
        <li class="clearfix Mandatory"><label class="label_name" style="width:87px"><i>*</i>商品名称 :</label><span class="formControls col-10"><input style="width:auto" type="text" title="管理员" value="<?php echo e($goods_name); ?>" id="form-field-1" readonly class="col-xs-10 col-sm-1"></span>
        </li>
       <div id="content" >
        ...
        <div class="border"  >
            ...
            <span class="formControls col-10"><input name="city_name[]" type="text" id="form-field-1" title="航空公司名字" class="col-xs-10 col-sm-5 " value="<?php echo e($v->city_name); ?>" style="width:542px" placeholder=" 请输入10字以内..." maxlength="30"></span>
            </li>
            <li class="clearfix Mandatory">
            <label class="label_name" style="float:left"><i>*</i>英文名(English) :</label>
            <span class="formControls col-10"><input name="englishname[]" value="<?php echo e($v->englishname); ?>" type="text" id="form-field-1" title="英文名" class="col-xs-10 col-sm-5 " style="width:542px" placeholder=" 请输入10字以内..." maxlength="30"></span>
            </li>
            <li class="clearfix Mandatory">
            <label class="label_name"><i>*</i>起飞机场 :</label><span class="formControls  end"><input name="begin_fei[]" value="<?php echo e($v->begin_fei); ?>" type="text" id="form-field-1" title="起飞机场"  placeholder=" 请输入10字以内..." maxlength="30"></span>
            <label class="label_name"><i>*</i>落地机场 :</label><span class="formControls  end"><input name="end_fei[]" type="text" value="<?php echo e($v->end_fei); ?>" id="form-field-1" title="日程机场"  placeholder=" 请输入10字以内..." maxlength="30"></span>

            </li>

             <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>起飞时间 :</label>
              <input type="text" autocomplete="off" onclick="status(this)" name="begin_fei_time[]" title="日期" class="laydate-icon start" id="start" value="<?php echo e($v->begin_fei_time); ?>" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
            </li>

             <li class="clearfix Mandatory">
              <label class="label_name"><i>*</i>出发城市 :</label>
              <span class="formControls col-10 ">
              <select name="begin_city[]" id="form-field-1" value="<?php echo e($v->begin_city); ?>" title="出发城市" style="margin-left:10px" class="col-xs-10 col-sm-5 province" data-value='山西省' placeholder="请选择出发城市" maxlength="30">
              </select>
            </li>
            <li class="clearfix Mandatory">
              <label class="label_name"><i>*</i>到达城市 :</label>
              <span class="formControls col-10 ">
              <select name="end_city[]" id="form-field-1" value="<?php echo e($v->end_city); ?>" title="到达城市" style="margin-left:10px" class="col-xs-10 col-sm-5 province" data-value='山西省' placeholder="请选择到达城市" maxlength="30">
              </select>
            </li>
            <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>路程时间 :</label>
              <input type="text" autocomplete="off" value="<?php echo e($v->begin_city_time); ?>" onclick="status(this)" name="begin_city_time[]" title="日期" class="laydate-icon start" id="startnv" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
              <em style="display:block; float:left;margin-right:10px;">至</em>
              <input type="text" autocomplete="off" value="<?php echo e($v->end_city_time); ?>" name="end_city_time[]" onclick="status(this)" class="laydate-icon" id="end" style="width:200px; padding-left:5px; display:block ;float:left" title="日期"></input>
            </li>
            ...
            <select name="type[]" id="form-field-1" title="状态" style="margin-left:10px" class="col-xs-10 col-sm-5 " placeholder="请填写价格" maxlength="30">
                ...
                <option <?php echo e($v->type == 0 ? 'selected' : ''); ?>  value="0">头等舱</option>
                <option <?php echo e($v->type == 1 ? 'selected' : ''); ?> value="1">公务舱</option>
                <option <?php echo e($v->type == 2 ? 'selected' : ''); ?> value="2">经济舱</option>
