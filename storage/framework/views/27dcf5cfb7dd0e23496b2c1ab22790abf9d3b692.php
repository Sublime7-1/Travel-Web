     ...
     <tbody>
      <tr class="head-img"> 
       <td> 
          ...
          <?php else: ?> 
            <img src="<?php echo e($userinfo->pic); ?>" /> 
          <?php endif; ?>
      ...
      <tr class="personal-info"> 
         ...
         <td class="title-val">
          <?php if($userinfo->nickname == ''): ?> 
            未设置 
          <?php else: ?> 
            <?php echo e($userinfo->nickname); ?> 
          <?php endif; ?> 
            <input type="hidden" class="old-nick-name" value="<?php echo e($userinfo->nickname); ?>" /> 
          </td> 
         <td class="input-val hide"> 
            <input type="text" id="nickname" name="nickname" class="nick-name fill-box" title="<?php echo e($userinfo->nickname); ?>" value="<?php echo e($userinfo->nickname); ?>" /><span class="tip-msg" id="nick"></span> 
          </td> 
      </tr> 
      <!-- 昵称报错 -->
      ...
      <tr class="personal-info"> 
         ...
         <td class="title-val"> 
          <?php if($userinfo->realname == ''): ?> 
            未设置 
          <?php else: ?> 
            <?php echo e($userinfo->realname); ?> 
          <?php endif; ?>
         </td> 
         <td class="input-val hide"> 
            <input type="text" id="realname" name="realname" class="real-name fill-box" title="<?php echo e($userinfo->realname); ?>" value="<?php echo e($userinfo->realname); ?>" /><span class="tip-msg" id="real"></span> 
          </td> 
      </tr> 
      <!-- 姓名报错 -->
      <tr class="name-tip hide"> 
      ...
      <tr class="personal-info"> 
         ...
         <td class="title-val"> 
            <span class="phonumber"><?php echo e($userinfo->phone); ?></span>&nbsp;&nbsp;&nbsp;
            <a href="https://i.tuniu.com/change-tel/" class="modify-tel">修改手机号&gt;&gt;</a> 
          </td> 
         <td class="input-val hide">
            <input type="text" class="tel-hide" disabled value="<?php echo e($userinfo->phone); ?>" /> 
         </td> 
      </tr> 
      <!-- 生日 -->
      <tr class="personal-info"> 
          ...
          <td class="title-val"> 
            <?php if($userinfo->birth == ''): ?> 
              未设置 
            <?php else: ?> 
              <?php echo e($userinfo->birth); ?> 
            <?php endif; ?>
            <input type="hidden" class="old-birth-day" value="1985-01-01" /> 
          </td> 
          <td class="input-val hide"> 
              <input type="date" name="birth" value="<?php echo e($userinfo->birth); ?>"> 
          </td> 
      </tr> 
      <!-- 性别 -->
      <tr class="personal-info"> 
          <td class="title-name">性别： </td> 
          <td class="title-val"> <?php echo e($userinfo->sex); ?> </td>  
          <td class="input-val hide"> 
            <input id="female" type="radio" class="sex" name="sex" value="1" <?php if($userinfo->sex == '男'): ?> checked <?php endif; ?>/> 男 &nbsp;&nbsp;&nbsp; 
            <input id="female" type="radio" class="sex" name="sex" value="0" <?php if($userinfo->sex == '女'): ?> checked <?php endif; ?>/> 女 &nbsp;&nbsp;&nbsp; 
            <input id="female" type="radio" class="sex" name="sex" value="2" <?php if($userinfo->sex == '保密'): ?> checked <?php endif; ?>/> 保密
      ...
      <tr class="personal-info"> 
          ...
          <td class="title-val"> <?php echo e($userinfo->email); ?>

          <td class="input-val hide">
            <input type="text" class="old-email-address" disabled value="<?php echo e($userinfo->email); ?>" /> </td> 
          </td> 
      </tr> 
      <!-- 地址 -->
      <tr class="personal-info"> 
          ...
          <td class="input-val hide"> 
            <input type="text" class="city-address fill-box" name="address" value="<?php echo e($userinfo->address); ?>" />
            <span class="tip-msg"></span> 
          </td> 
      </tr> 
      <!-- 婚姻 -->
      <tr class="personal-info"> 
          ...
          <td class="title-val"> <?php echo e($userinfo->marriage); ?> </td> 
          <td class="input-val hide"> 
            <select class="marry-status" name="marriage"> 
              <option value="0">请选择</option> 
              <option value="1" <?php if($userinfo->marriage == '未婚'): ?> selected <?php endif; ?>>未婚</option> 
              <option value="2" <?php if($userinfo->marriage == '已婚'): ?> selected <?php endif; ?>>已婚</option> 
            </select> 
          </td> 
      </tr> 
      <!-- 职业 -->
      <tr class="personal-info"> 
         ...
         <td class="title-val"> <?php echo e($userinfo->job); ?>&nbsp;&nbsp;&nbsp; 
         </td> 
         <td class="input-val hide"> 
            <select id="careerFirstName" class="careerFirstName" name="job">
              <option value="0">请选择</option>
              <option value="1" <?php if($userinfo->job == '白领/一般职员'): ?> selected <?php endif; ?>>白领/一般职员</option>
              <option value="2" <?php if($userinfo->job == '公务员/事业单位'): ?> selected <?php endif; ?>>公务员/事业单位</option>
              <option value="3" <?php if($userinfo->job == '工业/服务业人员'): ?> selected <?php endif; ?>>工业/服务业人员</option>
              <option value="4" <?php if($userinfo->job == '自由职业/个体户/私营业主'): ?> selected <?php endif; ?>>自由职业/个体户/私营业主</option>
              <option value="5" <?php if($userinfo->job == '无业/失业/下岗'): ?> selected <?php endif; ?>>无业/失业/下岗</option>
              <option value="6" <?php if($userinfo->job == '退休'): ?> selected <?php endif; ?>>退休</option>
              <option value="7" <?php if($userinfo->job == '学生'): ?> selected <?php endif; ?>>学生</option>
              <option value="8" <?php if($userinfo->job == '其他'): ?> selected <?php endif; ?>>其他</option>              
            </select> 
            <span class="tip-msg"></span> 
         </td> 
      </tr> 
      ...
      <tr class="personal-info"> 
          ...
          <td class="title-val"> <?php echo e($userinfo->degree); ?> </td> 
          <td class="input-val hide"> 
            <select class="education" name="degree"> 
              <option value="0">请选择</option> 
              <option value="1" <?php if($userinfo->degree == '博士及以上'): ?> selected <?php endif; ?>>博士及以上</option> 
              <option value="2" <?php if($userinfo->degree == '硕士'): ?> selected <?php endif; ?>>硕士</option> 
              <option value="3" <?php if($userinfo->degree == '本科'): ?> selected <?php endif; ?>>本科</option> 
              <option value="4" <?php if($userinfo->degree == '大专'): ?> selected <?php endif; ?>>大专</option> 
              <option value="5" <?php if($userinfo->degree == '大专及以下'): ?> selected <?php endif; ?>>大专及以下</option> 
            </select> 
            <span class="tip-msg"></span> 
          </td> 
      </tr> 
      ...
      <tr class="group-info hide"> 
         ...
         <td class="title-val">
            <?php if($userinfo->team == ''): ?> 
            未设置&nbsp;&nbsp;&nbsp;<span class="fill-tip">通过团队识别快速关联团队亲友</span> 
            <?php else: ?>
            <?php echo e($userinfo->team); ?>

            <?php endif; ?>
         </td> 
         <td class="input-val hide"> 
            <input type="text" id="group-code" name="team" class="group-code fill-box" placeholder="请输入关联团识别码" value="<?php echo e($userinfo->team); ?>" />
            <span class="tip-msg"></span> 
         </td> 
      </tr> 
      <!-- 座机 -->
      <tr class="group-info hide"> 
         ...
         <td class="title-val"> 
            ...
            <?php else: ?>
            <?php echo e($userinfo->tel); ?>

            <?php endif; ?>
         <td class="input-val hide"> 
            <input type="text" id="tel-num" name="tel" class="tel-num" placeholder="座机号" value="<?php echo e($userinfo->tel); ?>" />
