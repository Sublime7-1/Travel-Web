...
<body>
 <div class="margin clearfix">
   <div class="border clearfix">
       <span class="l_f">
        <a href="/admin/level/create" id="Competence_add" class="btn btn-warning" title="添加权限"><i class="fa fa-plus"></i> 添加权限</a>
     ...
     <thead>
      <tr>
        ...
        <tbody>
            <?php $__currentLoopData = $level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="center"><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
                <td><?php echo e($admin[$k]); ?></td>
                <td>1</td>
                <td class="hidden-480"><?php echo e($value->userid); ?></td>
                <td><?php echo e($value->desc); ?></td>
                <td>
                     <a title="编辑" href="/admin/level/<?php echo e($value->id); ?>/edit"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>        
                     <a title="删除" href="javascript:;"  onclick="Competence_del(this,'<?php echo e($value->id); ?>')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                </td>
            </tr> 
...
function Competence_del(obj,id){
  layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo e(url('admin/level')); ?>/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
