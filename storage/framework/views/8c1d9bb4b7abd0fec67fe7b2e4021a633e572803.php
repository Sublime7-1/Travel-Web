   ...
   <div id="Member_Ratings"> 
    <div class="d_Confirm_Order_style"> 
     ...
     <div class="table_menu_list container"> 
      <form action="/admin/discountActive/<?php echo e($data->id); ?>" method="post" id="typeerror">
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" value="<?php echo e($data->name); ?>" placeholder="   请输入30字内的内容" id="user-name" name="name"  style="margin-left: 0;width: 500px;height: 40px">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="formControls">
               <select name="goods_id" id="">
                 ...
                 <option value="<?php echo e($goods_v->id); ?>" <?php if($goods_v->id == $data->goods_id): ?> selected <?php endif; ?> ><?php echo e($goods_v->title); ?></option>
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 400px;">
                <input type="text" class="input-text" placeholder="   请输入优惠金额" id="user-name" name="discount_amount" value="<?php echo e($data->discount_amount); ?>" style="margin-left: 0;height: 40px">&nbsp;&nbsp;元
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div>
        <div class="form-group">
            ...
            <div class="formControls" style="width: 400px;">
                <input type="date" name="begin_time" value="<?php echo e(date('Y-m-d',$data->begin_time)); ?>" style="margin-left: 0px;">&nbsp;&nbsp;-<input type="date" name="end_time" value="<?php echo e(date('Y-m-d',$data->end_time)); ?>">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
         <div class="form-group">
