...
<?php $__env->startSection('title','安全设置'); ?>
    ...
    <div class="common_div">
        <div class="security_top clearfix">
            ...
            <div class="security_mess">
                ...
                <p class="s2">本次登录：<?php echo e(date('Y-m-d H:i:s',time())); ?>　</p>
        ...
        <div class="security_con">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>手机验证</td>
                    <!--TODO 这边的逻辑没看懂，后续来解决-->
                    <td><span class="grey">手机<?php echo e($phone); ?>已通过验证</span></td>
                    <td><a href="/home/personalsecurity/changephone">更改手机</a></td>
                </tr>
                <tr>
                    <td><span class="secur_icon icon_yes"></span></td>
                    <td>邮箱验证</td>
                    <td><span class="grey">邮箱<?php echo e($email); ?>已通过验证</span></td>
