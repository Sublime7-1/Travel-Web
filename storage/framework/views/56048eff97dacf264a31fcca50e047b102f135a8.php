 ...
 <head>
  ...
  <style>
      ...
      *html body {
      ...
      .veri_step_pic {
        background: url("/style/home/forget/verification_tit.png") no-repeat;
        width: 560px;
        height: 20px;
        margin-bottom: 5px;
      }
      ...
      .err {
        background: url("/assets/images/err.png") no-repeat 0 50%;
        padding-left: 20px;
      }
      .input-tip div {
        display: table-cell;
  ...
  <link type="text/css" rel="stylesheet" href="/style/home/forget/layer.css" id="skinlayercss" />
 </head> 
 <body id="index1200" class="index1200"> 
  ...
  <div class="head_bg"> 
   <div class="header"> 
    <div class="logo clearfix"> 
     <div class="logocon"> 
      <a href="/"> <img alt="途牛旅游网" title="途牛旅游网" src="/style/home/forget/logv2.png" /> </a> 
     </div> 
     <p class="head_tip"> 找回密码 </p> 
     <noscript> 
      <h1 class="head_notice_tips"> 您的浏览器禁用了javascript脚本，导致登录功能无法使用，请您先开启以后再使用找回密码功能。 </h1> 
     </noscript> 
     <p class="head_notice_tips" style="display: none;"> 您的浏览器禁用了cookie，开启Cookie之后才能找回密码， <a href="javascript:void(0)" id="howEnableCookie" style="color:rgb(3, 189, 252);"> 如何开启? </a> </p> 
    </div> 
   </div> 
  </div> 
  <!-- user head end --> 
  ...
  <div class="allWrap"> 
   <div class="main_top clearfix"> 
    ...
    <div class="main_top_r">
      已有途牛账号了？ 
     <a rel="nofollow" target="_self" href="/login"> 登录 </a> 
    </div> 
   </div> 
   ...
   <div id="user-reg" class="user-reg"> 
    <div id="reg-field"> 
     <div class="a_title title_oneStep clearfix"> 
      <a class="page_phone page_cur" href="javascript:void(0);" style="width:100%"> <span>密码找回</span> <span class="poptip-arrow poptip-arrow-top">▼</span> </a> 
     </div> 
     <div class="veri_step"> 
       ...
       <div id="mainPart" class="mainPart clearfix"> 
        ...
        <div class="main_item"> 
         <ul class="input-list mainCon">
          <input type="hidden" id="condition" name="condition" value="<?php echo e($condition); ?>"> 
          <li class="password_li"> 
           <div class="input"> 
            <label for="password">登录密码：</label> 
            <input type="password" id="password" tabindex="5" name="password" autocomplete="off" style="ime-mode:disabled;" class="txt-m" maxlength="20" placeholder="请输入密码" /> 
            <p class="forget-step2-tip">密码需由8位数字、字母或符号组成，至少含有2种及以上的字符。</p> 
           </div> 
          ...
          <li class="password_li"> 
           <div class="input"> 
            ...
            <input type="password" tabindex="6" name="passwordagain" id="passwordagain" style="ime-mode:disabled;" class="txt-m" value="" maxlength="20" placeholder="请输入密码" /> 
            <p class="forget-step2-tip">密码需由8位数字、字母或符号组成，至少含有2种及以上的字符。</p> 
           </div> 
         ...
         <div class="reg-check"> 
          <input type="button" value="下一步" id="submit" class="login_btn submit_btn" /> 
         </div> 
        </div> 
        <input id="pwd_s" type="hidden" value="" name="pwd_s" /> 
       </div> 
      </form> 
     </div> 
    </div> 
  ...
  $("#submit").click(function() {
    ...
    if (password.length < 8 || passwordagain.length < 8) {
      ...
      // 获取修改的密码
      var password = $("#password").val();
      $.get('/forget/reset',{'condition':condition,'password':password},function(data){
        if(data == 1){
          $('.veri_step_pic2').css('backgroundPosition','0 -48px');
          showDialog('重置成功,3秒后跳转登录页面');
          setTimeout(function() {
  ...
  $("[name='password']").on("input", function() {
    var _rule = /^(?![\d]+$)(?![a-zA-Z]+$)(?![^\da-zA-Z]+$).{8,16}$/i,
      value = this.value;
    if (!value || value.length < 8 || !_rule.test($.trim(value))) {
      $("#password-state").hide();
      ...
      if (pass.length > 0 && pass.length < 8) {
        ...
        if (level_score < 3 && pass.length >= 8) {
          rating = 2
        } else {
          if (level_score = 3 && pass.length >= 8) {
            rating = 3
  ...
  $("[name='passwordagain']").on("input", function() {
    ...
    if (!ele.value || ele.value.length < 8 || !_rule.test($.trim(ele.value))) {
      ...
      if (ele.value != $("#password").val()) {
        ...
        $("#passwordagain-tip").removeClass("err").show();
        $("#passwordagain-tip span").html("<img src='/style/home/register/dui.jpg' with='20' height='20'>");
        passwordFlag = true;
      }
    }
  });
