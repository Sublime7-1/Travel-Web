...
<div class="type_style">
 <div class="type_title">导航一级分类信息</div>
  ...
  <form action="/admin/NavigateFirst/<?php echo e($data->id); ?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-user-add">
    ...
    <div class="Operate_cont clearfix">
      ...
      <div class="formControls ">
        <select name="level" class="input-text" style="margin-left: 10px;" id="">
          ...
          <?php for($i=1; $i<10; $i++): ?>
          <option value="<?php echo e($i); ?>" <?php if($data->level == $i): ?> selected <?php endif; ?>>第<?php echo e($i); ?>层</option>
          <?php endfor; ?>
        </select>
      </div>
    </div>
    <div class="Operate_cont clearfix">
      ...
      <div class="formControls " >
        <?php if(is_file('.'.$data->pic)): ?>
          <img src="../../../<?php echo e($data->pic); ?>" width="80" alt="">
        <?php else: ?>
          无
        <?php endif; ?>
      </div>
