    ...
    <div class="d_Confirm_Order_style"> 
     ...
     <div class="table_menu_list container"> 
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" id="user-name" name="title" readonly value="<?php echo e($data->title); ?>" required style="margin-left: 0;width: 500px;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div>
        <div class="form-group">
            ...
            <div class="formControls">
                <script id="editor" type="text/plain" name="content" readonly style="width:1000px;height:400px;"><?php echo e($data->content); ?></script>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
