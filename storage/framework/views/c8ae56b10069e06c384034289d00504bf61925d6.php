     ...
     <div class="table_menu_list container"> 
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" id="user-name" value="<?php echo e($data->user_name); ?>" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" id="user-name" value="<?php echo e($data->admin_name); ?>" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div>
        <div class="form-group">
            ...
            <div class="formControls">
                <script id="editor" type="text/plain" name="content" readonly style="width:1000px;height:400px;"><?php echo e($data->reply); ?></script>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
        <div class="form-group">
            <label class="form-label" style="font-size: 16px;width: 120px"><span class="c-red">* </span>回复时间 : </label>
            <div class="formControls">
                <input type="text" class="input-text" id="user-name" value="<?php echo e($data->reply_time); ?>" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
         <div class="form-group col-md-offset-1">
            ...
            <div class="formControls" style="margin-left: 36px">
                <a href="/admin/comment" class="btn btn-info">返回列表页</a>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
         </div>    
     </div> 
