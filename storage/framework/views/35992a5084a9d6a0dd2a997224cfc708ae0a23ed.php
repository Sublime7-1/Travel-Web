   ...
   <div id="Member_Ratings"> 
    <div class="d_Confirm_Order_style"> 
     ...
     <div class="table_menu_list container"> 
      <form action="/admin/message" method="post" id="typeerror">
        ...
        <div class="form-group">
            <label class="form-label" style="font-size: 16px;width: 120px"><span class="c-red">* </span>消息接收者 : </label>
            <div class="formControls">
                <select name="uid" style="width: 180px">
