       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
                ...
                <th width="70">会员等级</th>  
                <th width="70">成长值</th>                
                <th width="250">会员到期时间</th>
                <th width="200">激活状态</th>
                <th width="200">用户ID</th>
            </tr>
		</thead>
	<tbody>
  		<?php $__currentLoopData = $rank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          <td><?php echo e($v->id); ?></td>
          <td><?php echo e($v->nickname); ?></u></td>
          <td><?php echo e($v->realname); ?></td>
          <td><?php echo e($sex[$v->sex]); ?></td>
          <td><?php echo e($v->phone); ?></td>
          <td><?php echo e($v->email); ?></td>
          <td><?php echo e(date('Y-m-d',$v->addtime)); ?></td>
          <td><?php echo e($status[$v->rank]); ?></td>
          <td><?php echo e($v->grow_value); ?></td>
          <td><?php echo e($v->endtime); ?></td>
          <td><?php echo e($v->status==0?'未激活':'已激活'); ?></td>
