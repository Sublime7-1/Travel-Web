...
<div class="margin clearfix">
 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
      <form action="/admin/goodsinfo/city" method="post" id="formtip">
       ...
       <div id="content" >
        ...
        <div class="border"  >
            ...
            <label class="label_name"><i>*</i>落地机场 :</label><span class="formControls  end"><input name="end_fei[]" type="text" id="form-field-1" title="日程机场"  placeholder=" 请输入10字以内..." maxlength="30"></span>

            </li>

             <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>起飞时间 :</label>
              <input type="text" autocomplete="off" onclick="status(this)" name="begin_fei_time[]" title="日期" class="laydate-icon start" id="start" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
            </li>
            ...
            <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>路程时间 :</label>
              <input type="text" autocomplete="off" onclick="status(this)" name="begin_city_time[]" title="日期" class="laydate-icon start" id="startnv" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
              <em style="display:block; float:left;margin-right:10px;">至</em>
              <input type="text" autocomplete="off" name="end_city_time[]" onclick="status(this)" class="laydate-icon" id="end" style="width:200px; padding-left:5px; display:block ;float:left" title="日期"></input>
            </li>
        ...
        <div class="border"  >
            ...
            <label class="label_name"><i>*</i>落地机场 :</label><span class="formControls  end"><input name="end_fei[]" type="text" id="form-field-1" title="落地机场"  placeholder=" 请输入10字以内..." maxlength="30"></span>
             ...
             <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>起飞时间 :</label>
              <input type="text" autocomplete="off" onclick="status(this)" name="begin_fei_time[]" title="日期" class="laydate-icon start" id="startz" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
            </li>
            ...
            <li class="clearfix cates" ><label class="label_name" style="width:119px;text-align: left;">　<i>*</i>路程时间 :</label>
              <input type="text" autocomplete="off" onclick="status(this)" name="begin_city_time[]" title="日期" class="laydate-icon start" id="statusabc" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
              <em style="display:block; float:left;margin-right:10px;">至</em>
              <input type="text" autocomplete="off" name="end_city_time[]" onclick="status(this)" class="laydate-icon" id="endvz321" style="width:200px; padding-left:5px; display:block ;float:left" title="日期"></input>
            </li>
