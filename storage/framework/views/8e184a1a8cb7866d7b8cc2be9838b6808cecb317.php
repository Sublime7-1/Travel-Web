  ...
  <div class="margin clearfix"> 
   <div class="cover_style" id="cover_style"> 
    <div class="search_style"> 
     <ul class="search_content clearfix"> 
      <form action="/admin/accounts" method="get">
        <li><label class="l_f">用户</label><input name="keyword" value="<?php echo e(isset($keyword) ? $keyword : ''); ?>" type="text" class="text_add" placeholder="用户名称" style=" width:250px" /></li> 
    ...
    <div class="border clearfix"> 
     ...
     <span class="r_f">共：<b><?php echo e($total); ?> </b>个账户</span> 
    </div> 
    <!--账户管理--> 
    <div class=""> 
     <table class="table table-striped table-bordered table-hover" id="sample-table"> 
      ...
      <tbody> 
       ...
       <tr> 
        ...
        <td><u style="cursor:pointer" class="text-primary" onclick="member_show('<?php echo e($v->uname); ?>','member-show.html','1031','500','400')"><?php echo e($v->uname); ?></u></td> 
        <td><?php echo e($v->pay_total); ?><span> ￥</span></td> 
        <td><?php echo e($v->pay_money); ?><span> ￥</span></td> 
        <td><?php echo e($v->pay_why); ?></td> 
        <td><?php echo e($v->pay_time); ?></td> 
        <td class="td-status">
            <?php if($v->status == '启用'): ?>
        ...
        <td class="td-manage"> 
          <?php if($v->status == '停用'): ?>
          <a onclick="member_start(this,<?php echo e($v->id); ?>)" href="javascript:;" title="启用" class="btn btn-xs btn-close"><i class="fa fa-check  bigger-120"></i></a>
          <?php else: ?>
          <a onclick="member_stop(this,<?php echo e($v->id); ?>)" href="javascript:;" title="停用" class="btn btn-xs btn-success"><i class="fa fa-close  bigger-120"></i></a>
          <?php endif; ?> 
          <a href="javascript:ovid()" name="Account_Details.html" class="btn btn-xs  btn-warning Account_Details" onclick="generateOrders(<?php echo e($v->id); ?>);" title="<?php echo e($v->uname); ?>用户详细"> <i class="fa fa-list-ul bigger-120"></i></a> 
        </td> 
       </tr> 
