...
<div class="type_style">
 <div class="type_title">产品类型信息</div>
  ...
  <form action="/admin/leveltype/update" method="post" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>分类名称：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($type->typename); ?>" placeholder="" id="user-name" name="typename">
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>控制器/方法名：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($type->ac); ?>" placeholder="" id="user-name" name="ac">
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>pid：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($type->pid); ?>" placeholder="" id="user-name" name="pid">
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>路径：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($type->path); ?>" placeholder="" id="user-name" name="path">
      </div>
    </div>
    <div class="">
