 ...
 <div class="sort_style">
 	...
 	<form action="/admin/comment_type" method="get"> 
      <ul class="search_content clearfix">
       <li><label class="l_f">评论类名 :</label><input name="name" value="<?php echo e(isset($request->name) ? $request->name : ''); ?>" type="text" class="text_add" placeholder="输入评论类名" style=" width:200px;height: 32px"></li>
     ...
     <div class="border clearfix">
       ...
       <span class="r_f">共：<b><?php echo e($total); ?> </b>类</span>
     </div>
	<!-- 验证消息 -->
      <?php $errorss='错误信息 :' ?>
  ...
  <div class="sort_list">
	...
	<tbody>
      ...
      <tr>
       ...
       <td class="td-manage">
         <a title="查看" href="/admin/comment_type/<?php echo e($v->id); ?>"  class="btn btn-xs btn-info" >点击查看</a>   
       </td>
       <td class="td-status">
        	<?php if($v->status == '启用'): ?>
