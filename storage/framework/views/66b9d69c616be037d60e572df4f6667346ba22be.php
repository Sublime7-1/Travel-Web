...
<div class="type_style">
  ...
  <form action="/admin/NavigateSecond/<?php echo e($data->id); ?>" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>分类名称：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($data->name); ?>" placeholder="" id="user-name" name="name">
      </div>
    ...
    <?php if(is_file('.'.$data->pic)): ?>
    <div class="Operate_cont clearfix">
      <label class="form-label">图片：</label>
      <div class="formControls " >
        <img src="<?php echo e($data->pic); ?>" width="100px" name="pic" style="margin-left: 10px;">
      </div>
    </div>
    <?php endif; ?>
    <div class="Operate_cont clearfix">
    ...
    <div class="Operate_cont clearfix">
      ...
      <div class="formControls " >
        <input type="radio" name="is_chinese" value="1" style="margin-left: 10px;" <?php if($data->is_chinese=='国内'): ?> checked <?php endif; ?>>国内
        <input type="radio" name="is_chinese" value="2" style="margin-left: 10px;" <?php if($data->is_chinese=='国外'): ?> checked <?php endif; ?>>国外
        <input type="radio" name="is_chinese" value="3" style="margin-left: 10px;" <?php if($data->is_chinese=='其他'): ?> checked <?php endif; ?>>其他
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>热门玩法：</label>
      <div class="formControls " >
        <input type="radio" name="is_popular_game" value="1" style="margin-left: 10px;" <?php if($data->is_popular_game=='是'): ?> checked <?php endif; ?>>是
        <input type="radio" name="is_popular_game" value="0" style="margin-left: 10px;" <?php if($data->is_popular_game=='否'): ?> checked <?php endif; ?>>否
      </div>
    </div>
