...
<div class="add_menber" id="add_menber_style" style="border:1px solid #b0b0b0" >
    <form action="/admin/order/form/doedit/<?php echo e($id); ?>" method="post" id="submit1">
      <ul class=" page-content">
       <li><label class="label_name">&nbsp;姓&nbsp; &nbsp;名：</label><span class="add_name"><input value="<?php echo e($user->name); ?>" name="name" top="用户名" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
       <li><label class="label_name">英文名:</label><span class="add_name"><input name="englishname" top="密码" type="text" value="<?php echo e($user->englishname); ?>"  class="text_add"/></span><div class="prompt r_f"></div></li>
       <li><label class="label_name">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</label><span class="add_name">
       <label><input name="sex" type="radio" <?php echo e($user->sex == 0 ? 'checked' : ''); ?> class="ace" value="0"><span class="lbl">女</span></label>&nbsp;&nbsp;&nbsp;
       <label><input name="sex" type="radio" <?php echo e($user->sex == 1 ? 'checked' : ''); ?> class="ace"><span class="lbl" value="1">男</span></label>&nbsp;&nbsp;&nbsp;
       </span>
       <div class="prompt r_f"></div>
       </li>
        <input type="hidden" name="id" value="<?php echo e($id); ?>" />
       <li><label class="label_name">移动电话：</label><span class="add_name"><input name="phone" top="移动电话" type="text"  value="<?php echo e($user->phone); ?>" class="text_add"/></span><div class="prompt r_f"></div></li>
        <input type="hidden" name="card_type" value="<?php echo e($user->card_type); ?>" />
        <input type="hidden" name="order_id" value="<?php echo e($user->order_id); ?>" />
        <input type="hidden" name="card_date" value="<?php echo e($user->card_date); ?>" />
        <input type="hidden" name="burn_date" value="<?php echo e($user->burn_date); ?>" />
      <li><label class="label_name">护照：</label><span class="add_name"><input name="card_num" top="1" type="text"  value="<?php echo e($user->card_num); ?>" class="text_add"/></span><div class="prompt r_f"></div></li>
       ...
       <?php echo e(csrf_field()); ?>
        ...
        <div>
            ...
            <a href="/admin/order/form/<?php echo e($user->order_id); ?>" type="button" value="返回上一步"  class="btn ace button1" id="quxiao" style="background:#b0b0b0">返回上一步</a>
        </div>
      </ul>
    </form>
 </div>
