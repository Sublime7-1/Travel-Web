  ...
  <?php endif; ?>
    ...
    <form action="/admin/article" method="post" enctype="multipart/form-data" id="bb">
     ...
     <ul>
      ...
      <label class="label_name"><i>*</i>文章标题</label><span class="formControls col-10"><input name="title" type="text" value="<?php echo e(old('title')); ?>" id="title" required id="form-field-1" class="col-xs-10 col-sm-5 "></span>
      </li>
      ...
      <span class="formControls col-10"><input name="source" id="source" required value="<?php echo e(old('source')); ?>" type="text" id="form-field-1" class="col-xs-10 col-sm-2 "></span>
      </li>
      ...
      <span class="formControls col-10"><script id="editor" name="content" type="text/plain" style="width:80%;height:400px; margin-left:10px;"><?php echo e(old('content')); ?></script> </span>
      </li>
