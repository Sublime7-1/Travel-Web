 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <button onclick="member_edit('编辑','/admin/leveltype/create','4','','510')" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加分类</button>
        <a href="javascript:void()" class="btn btn-danger"><i class="icon-trash"></i>批量删除</a>
        <a href="/admin/leveltype/check/<?php echo e($pid); ?>" class="btn btn-warning"><i class="icon-plus"></i>返回上一步</a>
       </span>
    ...
    <tbody>
     ...
     <tr>
        ...
        <td width="80px"><?php echo e($value->id); ?></td>               
        <td width="250px"><u style="cursor:pointer" class="text-primary" onclick=""><?php echo e($value->typename); ?></u></td>
        <td width="100px"><?php echo e($value->pid); ?></td>
        <td width="100px"><?php echo e($value->path); ?></td> 
        <td width="100px"><?php echo e($value->ac); ?></td> 
        <td class="td-manage">
        <a title="编辑" onclick="member_edit('编辑','/admin/leveltype/mem_add/<?php echo e($value->id); ?>','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" >添加子分类</a> 
       
       </td>
       <td class="td-manage">
        <a title="编辑"  href="/admin/leveltype/check/<?php echo e($value->id); ?>"  class="btn btn-xs btn-warning" >查看子分类</a> 
       
       </td>
        <td class="td-manage">

        <a title="编辑" onclick="member_edit('编辑','/admin/leveltype/<?php echo e($value->id); ?>/edit','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
    ...
    <div style="margin:0 auto;text-align:center" id="list"><?php echo e($type->links()); ?></div>
    </div>     
  </div>
 </div>
</div>
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      ...
      $.post("<?php echo e(url('admin/leveltype')); ?>/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
