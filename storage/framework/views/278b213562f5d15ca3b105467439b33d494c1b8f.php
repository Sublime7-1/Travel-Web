            ...
            <div class="content_top">
                <div class="crumbs">
                    ...
                    <p>
                        ...
                        <i>&gt;</i>
                        <a href="/home/search/<?php echo e($keyword); ?>-1"><?php echo e($keyword); ?></a>
                        <i>&gt;</i>
                        <span>所有产品</span>
                    </p>
                </div>
        ...
        <div class="prop_list prop-list-new clearfix">
        	...
        	<div class="clearfix prop_item chooseitem" id="hadSelected">
                <dl class="clearfix poi_selecters">
                    ...
                    <dd>
                        <ul class="had_select">
                            <?php $__currentLoopData = $hadselected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hadselected_k => $hadselected_v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input class="none s_checked" type="checkbox" name="related_destination_id" value="<?php echo e($hadselected_v[1]); ?>" checked="checked">
                            <li name="related_destination_id">
                                <span class="select_log"><?php echo e($hadselected_v[2]); ?></span>
                                <a href="javascript:void(0)" rel="nofollow">
                                    <?php echo e($hadselected_v[0]); ?>

                                    <span class="deltab" data-href="/home/deleteOneKeyword/<?php echo e($hadselected_k); ?>-<?php echo e($keyword); ?>"></span>
                                </a>
                            </li>
			...
			<?php endif; ?>
            <!-- 搜索分类 -->
            <?php $__currentLoopData = $search_cates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $search_cates_v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="clearfix prop_item needed_filter mult_select isOneLine hasMoreChoice" data-id="<?php echo e($search_cates_v->id); ?>">
                    <dl class="clearfix poi_day_selecter xc_days">
                        <dt><span class="list_gaiban_icon <?php echo e(isset($search_cates_v->icon) ? $search_cates_v->icon : ''); ?>"></span><?php echo e($search_cates_v->name); ?></dt>
                        <dd class="onlyOneLine"	>
                            <ul class="list_3 duration_select ">
                                <li class="hide">
                                    <a class="input_hide cur_city" href="javascript:void(0);" rel="nofollow">全部</a>
                                </li>
                                <?php $__currentLoopData = $search_cates_v->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cates_child_k => $cates_child_v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($search_cates_v->name == '出游时间'): ?>
                                <li class="filter_input ">
                                    <input type="checkbox" value="<?php echo e($cates_child_v); ?>" name="">
                                    <a href="/home/search/<?php echo e($keyword); ?>-2?name=<?php echo e($cates_child_v); ?>&pid=<?php echo e($search_cates_v->id); ?>&pname=<?php echo e($search_cates_v->name); ?>" rel="nofollow"><?php echo e($cates_child_v); ?></a>
                                </li>
                                <?php else: ?>
                                <li class="filter_input ">
                                    <input type="checkbox" value="<?php echo e($cates_child_v->name); ?>" name="">
                                    
                                    <a href="/home/search/<?php echo e($keyword); ?>-2?name=<?php echo e($cates_child_v->name); ?>&pid=<?php echo e($search_cates_v->id); ?>&pname=<?php echo e($search_cates_v->name); ?>" rel="nofollow"><?php echo e($cates_child_v->name); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
// 默认为显示更多按钮
    ...
    $('.J_clear_class_all').click(function(){
    	location.href = "/home/deleteKeyword/<?php echo e($keyword); ?>";
    });
...
<div class="thelist"> 
        <ul class="thebox clearfix">   
            <?php $__currentLoopData = $goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goods_v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>         
                        <li>
                            <div class="theinfo">
                                <a class="clearfix" m="点击_产品列表_欧洲_1_210166734" href="/home/goodsinfo/<?php echo e($goods_v->id); ?>" target="_blank" rel="nofollow">
                                    <div class="imgbox">
                                        <div class="img">                         
                                                        <span class="icon-box">
                                                            <span class="icon gty-icon-new">跟团</span>
                                                        </span>                     
                                            <img src="<?php echo e($goods_v->pic); ?>" style="display: block;">  
                                        </div>
                                    </div>
                                    <dl class="detail">
                                        <dt>
                                            ...
                                            <?php if(!empty($goods_v->city)): ?>
                                            <p class="subtitle">     
                                                    <span><?php echo e($goods_v->city); ?>出发</span>   
                                                <span>|&nbsp;<?php echo e($goods_v->city); ?>成团</span> 
                                               <!--  <span class="sub-tuijian">|&nbsp;卢浮宫入内 新天鹅堡 罗马 佛罗伦萨 威尼斯 五渔村 自营</span>    --> 
                                            </p>
                                            <?php endif; ?>
                                        </dt>
                                            <dd class="overview" title="<?php echo e(join(',',$goods_v->place)); ?>">
                                                <label>包含景点：</label>
                                                <span><?php echo e(count($goods_v->place)); ?>个景点，</span>
                                                <span class="overview-scenery"><?php echo e(join(',',$goods_v->place)); ?></span>
                                            </dd>
                                        <dd class="tqs">
                                        		<?php if(!empty($goods_v->receptionist)): ?>
                                                <span class="brand"><label>供应商：</label><span><?php echo e($goods_v->receptionist); ?></span></span>
                                                <?php endif; ?>
                                                
                                                <span class="time"><label>团期：</label><span>
                                                <?php if(!empty($goods_v->tuanqi)): ?>
                                                <?php echo e(join(',',$goods_v->tuanqi)); ?>
                                    ...
                                    <div class="priceinfo">
                                        <div class="tnPrice">                                   
                                            <i>¥</i>                                          
                                            <em><?php echo e($goods_v->price); ?></em>起                                           
                                        </div>
                                        <div class="comment-sat clearfix">                                             
                                                <div class="comment-satNum">
                                                    满意度<span><i><?php echo e($goods_v->manyi); ?></i>%</span>
                                                </div>
                                               
                                                <div class="trav-person">
                                                    
                                                    <p class="person-num"><i><?php echo e($goods_v->play_num); ?></i>人已出游</p>
                                                    <?php if($goods_v->dianping > 0): ?>
                                                    <p class="person-comment"><i><?php echo e($goods_v->dianping); ?>人</i>点评</p>  
													<?php endif; ?>
                                                </div>                                          
                                        </div>
                                    </div>
