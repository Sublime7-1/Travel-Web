 ...
 <div class="state-overview clearfix">
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <section class="panel">
                          ...
                          <div class="value">
                              <h1>￥<?php echo e(number_format($money)); ?></h1>
                              <p>交易记录</p>
                          </div>
                      </section>
                  </div>
          ...
          <div class="title_name">订单统计信息</div>
           ...
           <tbody>
           <tr><td class="name">未处理订单：</td><td class="munber"><a href="#"><?php echo e($order_no); ?></a>&nbsp;个</td></tr>
         ...
         <div class="Order_Statistics">
          <div class="title_name">商品统计信息</div>
           <table class="table table-bordered">
           <tbody>
           <tr><td class="name">商品总数：</td><td class="munber"><a href="#"><?php echo e($goods1); ?></a>&nbsp;个</td></tr>
           <tr><td class="name">回收站商品：</td><td class="munber"><a href="#">10</a>&nbsp;个</td></tr>
           <tr><td class="name">上架商品：</td><td class="munber"><a href="#"><?php echo e($goods2); ?></a>&nbsp;个</td></tr>
           <tr><td class="name">下架商品：</td><td class="munber"><a href="#"><?php echo e($goods3); ?></a>&nbsp;个</td></tr>
           <tr><td class="name">商品评论：</td><td class="munber"><a href="#"><?php echo e($goodspin); ?></a>&nbsp;条</td></tr>
         ...
         <div class="Order_Statistics">
          <div class="title_name">会员登录统计信息</div>
           <table class="table table-bordered">
           <tbody>
           <tr><td class="name">注册会员登录：</td><td class="munber"><a href="#"><?php echo e($user_num); ?></a>&nbsp;次</td></tr>
          </tr>
           </tbody>
          </table>
         </div> 
         ...
         <div class="news_style">
          ...
          <ul class="list">
            <?php $__currentLoopData = $m; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <li><i class="icon-bell red"></i><a href="#"><?php echo e($v->title); ?></a></li>
