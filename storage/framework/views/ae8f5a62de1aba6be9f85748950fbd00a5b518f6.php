 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
      <form action="/admin/goodsinfo/travel" method="post" id="formtip">
       ...
       <ul>
        <li class="clearfix Mandatory"><label class="label_name" style="width:87px"><i>*</i>管理员名称 :</label><span class="formControls col-10"><input style="width:auto" type="text" title="管理员" value="<?php echo e($goods_name); ?>" id="form-field-1" readonly class="col-xs-10 col-sm-1"></span>
        </li>
       <div id="content">
        <div class="border" >
