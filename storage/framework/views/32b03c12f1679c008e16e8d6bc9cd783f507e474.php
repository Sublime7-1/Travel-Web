   ...
   <div class="admin_modify_style" id="Personal">
      ...
      <div class="xinxi">
        <form onsubmit="return false" id="submit2">
            <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名： </label>
              <div class="col-sm-9"><input type="text" name="name" id="website-title" value="<?php echo e($admin->name); ?>" class="col-xs-7 text_info" disabled="disabled">
              ...
              <div class="col-sm-9"><input type="text" name="phone" id="website-title" value="<?php echo e($admin->phone); ?>" class="col-xs-7 text_info" disabled="disabled"></div>
              </div>
              <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">电子邮箱： </label>
              <div class="col-sm-9"><input type="text" name="email" id="website-title" value="<?php echo e($admin->email); ?>" class="col-xs-7 text_info" disabled="disabled"></div>
              </div>
          </form>
          ...
          <div class="col-sm-9" > <span><?php echo e($admin->status); ?></span></div>
          </div>
           <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">注册时间： </label>
          <div class="col-sm-9" > <span><?php echo e($admin->time); ?></span></div>
          </div>
    ...
    <tbody>
      <tr>
        ...
        <td><?php echo e($ip); ?></td>
        <td><?php echo e($admin->lasttime); ?></td>      
      </tr>
