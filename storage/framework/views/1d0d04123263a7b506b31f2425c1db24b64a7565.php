...
<div class="type_style">
  ...
  <form action="/admin/coupontype/<?php echo e($data->id); ?>" method="post" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>分类名称：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="<?php echo e($data->name); ?>" required id="user-name" name="name">
      </div>
