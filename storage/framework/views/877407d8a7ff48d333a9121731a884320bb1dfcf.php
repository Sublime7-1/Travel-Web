    ...
    <?php endif; ?>
     ...
     <div class="table_menu_list container"> 
      <form action="/admin/comment" method="post">
        ...
        <input type="hidden" name="comment_id" value="<?php echo e($data['comment_id']); ?>">
        <input type="hidden" name="admin_id" value="<?php echo e(session('AdminUserInfo.id')); ?>">

        <?php echo e(csrf_field()); ?>

        <br>  
        <h2 style="text-align: center;">评论回复</h2>
        <br>
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" id="user-name" value="<?php echo e($data['uname']); ?>" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" id="user-name" value="<?php echo e(session('AdminUserInfo.name')); ?>" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div>
        <div class="form-group">
            ...
            <div class="formControls">
                <script id="editor" type="text/plain" name="reply" style="width:1000px;height:400px;"><?php echo e(old('content')); ?></script>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
         <div class="form-group col-md-offset-1">
            ...
            <div class="formControls" style="margin-left: 36px">
                ...
                <a href="javascript:;" class="btn btn-info" onclick="return history.go(-1)">返回</a>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
         </div> 
        </form>   
