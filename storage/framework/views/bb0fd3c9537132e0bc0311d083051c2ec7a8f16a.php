          ...
          <ul class="input-list mainCon"> 
              ...
              <li> 
                  <div class="input" style="width: 800px"> 
                    ...
                    <input value="" type="text" tabindex="1" name="phone" id="phone" maxlength="11"  class="txt-m " autocomplete="off" placeholder="请输入手机号码" value="<?php echo e(old('phone')); ?>"/>
                    <span id="judge"></span>
                  </div>
              </li> 
              <!-- 验证码 --> 
              <li class="identify_box"> 
                <div class="input" style="width: 800px"> 
                  ...
                  <span class="txt-m identify_con"> 
                    <input type="text" class="identify_code txt_grey" id="yzm" name="yzm" placeholder="不区分大小写" maxlength="5" tabindex="2" value="<?php echo e(old('yzm')); ?>" style="height: 20px;width: 180px" /> 
              ...
              <li class="verify-box2_2">
                <div class="input" style="width: 800px">
                  ...
                  <input type="text" class="txt-m txt_grey" id="code" placeholder="请输入校验码" name="code" maxlength="6" tabindex="3" value="<?php echo e(old('code')); ?>">
