    ...
    <?php endif; ?>
     ...
     <div class="table_menu_list container"> 
      <form action="/admin/advices" method="post">
        ...
        <input type="hidden" name="advices_id" value="<?php echo e($data['advices_id']); ?>">
        ...
        <div class="form-group">
            ...
            <div class="formControls">
                <script id="editor" type="text/plain" name="content" style="width:1000px;height:400px;"><?php echo e(old('content')); ?></script>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
