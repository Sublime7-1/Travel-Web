   ...
   <div id="Member_Ratings"> 
    <div class="d_Confirm_Order_style"> 
     <div class="search_style"> 
      <form action="/admin/coupon/indexs" method="get">
        ...
        <ul class="search_content clearfix"> 
         <li><label class="l_f">优惠券面值 :</label><input name="money" type="text" class="text_add" placeholder="  输入数字..." value="<?php echo e(isset($request->money) ? $request->money : ''); ?>" style=" width:200px;height: 36px" /></li> 
     ...
     <div class="border clearfix"> 
      ...
      <span class="l_f"><a href="/admin/coupon/create" class="btn btn-info"><i class="icon-plus"></i>添加优惠劵</a> </span> 
      ...
      <table class="table table-striped table-bordered table-hover" id="sample-table"> 
       <thead> 
        <tr> 
         ...
         <th width="80">PID</th> 
         <th width="80">PATH</th> 
         <th width="120">优惠劵值(<b style="color: black"> 元</b> )</th> 
         <th width="140">满金额可用(<b style="color: black"> 元</b> )</th> 
         <th width="160">优惠劵描述</th> 
         <th width="100">有效时间</th> 
         <th width="100">失效时间</th> 
         <th width="150">活动主题</th> 
         <th width="300">活动内容</th> 
         <th width="140">操作</th> 
        </tr> 
       </thead> 
       <tbody>
       <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <tr> 
         ...
         <td><?php echo $v->content; ?></td>   
       	 <td>
          <a title="编辑" href="/admin/coupon/<?php echo e($v->id); ?>/edit" class="btn btn-xs btn-info"><i class="icon-edit  bigger-120"></i></a> 
