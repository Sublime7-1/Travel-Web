<form action="/admin/adverttype/doadd" method="post" class="form form-horizontal" id="form-user-add" enctype="multipart/form-data">
    ...
    <div class="Operate_cont clearfix">
     ...
     <div class="Operate_cont clearfix">
        ...
        <div class="formControls">
            <input name="pid" readonly value="<?php echo e($data->id); ?>" type="text" id="form-field-3" class="col-xs-10 col-sm-6" style="width:80px" />
        </div>
     </div> 
     <div class="Operate_cont clearfix">
        <label class="form-label"><span class="c-red">*</span>PATH：</label>
        <div class="formControls">
            <input name="path" readonly value="<?php echo e($data->path); ?>,<?php echo e($data->id); ?>" type="text" id="form-field-3" class="col-xs-10 col-sm-6" style="width:80px" />
        </div>
     </div>
     <div class="Operate_cont clearfix">
