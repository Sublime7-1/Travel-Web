   ...
   <div id="Member_Ratings"> 
    <div class="d_Confirm_Order_style"> 
     <div class="search_style"> 
      <form action="/admin/discountActive" method="get">
        ...
        <ul class="search_content clearfix"> 
         <li><label class="l_f">商品名称 :</label><input name="title" type="text" class="text_add" placeholder="  输入商品名称..." value="<?php echo e(isset($request->title) ? $request->title : ''); ?>" style=" width:200px;height: 36px" /></li> 
     ...
     <div class="border clearfix">
      ...
      <span class="r_f">共：<b><?php echo e(isset($num) ? $num : '0'); ?> </b>条</span> 
     </div> 
     <!----> 
      ...
      <table class="table table-striped table-bordered table-hover" id="sample-table"> 
       ...
       <tbody>
        ...
        <tr> 
         ...
         <td><?php echo e($v->discount_amount); ?></td> 
         <td><?php echo $v->content; ?></td> 
         <td><?php echo e($v->begin_time); ?></td> 
         <td><?php echo e($v->end_time); ?></td>   
       	 <td>
          <a title="编辑" href="/admin/discountActive/<?php echo e($v->id); ?>/edit" class="btn btn-xs btn-info"><i class="icon-edit  bigger-120"></i></a> 
          <a title="删除" href="javascript:;" onclick="member_del(this,<?php echo e($v->id); ?>)" class="btn btn-xs btn-danger"><i class="icon-trash  bigger-120"></i></a> 
       	 </td> 
        </tr> 
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       </tbody> 
...
function member_del(obj,id){
  // alert(id);
    ...
    $.post('/admin/discountActive/'+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
      // alert(data);
      if(data == 1){
