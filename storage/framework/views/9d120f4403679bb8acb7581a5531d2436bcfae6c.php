 ...
 <div id="products_style">
    <div class="search_style">
     <form action="/admin/NavigateFirst" method="get">
      <ul class="search_content clearfix">
       <li><label class="l_f">分类名称</label><input name="keyword" value="<?php echo e(isset($keyword) ? $keyword : ''); ?>" type="text"  class="text_add" placeholder="输入分类名称"  style=" width:250px"/></li>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <tr>
        ...
        <td class="td-manage">
        <a title="编辑" onclick="member_edit('编辑','/admin/navigateFirstAdd/<?php echo e($v->id); ?>','4','','510')" href="javascript:;"  class="btn btn-xs btn-info" >添加子分类</a> 
       </td>
       <td class="td-manage">
        <a title="编辑"  href="/admin/NavigateFirst/<?php echo e($v->id); ?>"  class="btn btn-xs btn-warning" >查看子分类</a> 
