    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
        <form action="/admin/coupontype" method="get">
           <li><label class="l_f">分类名称</label><input name="name" value="<?php echo e(isset($request->name) ? $request->name : ''); ?>" type="text"  class="text_add" placeholder="  输入优惠劵分类名称..."  style=" width:250px"/></li>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
         <tr>
            ...
            <td><u style="cursor:pointer" class="text-primary" onclick=""><?php echo e($v->name); ?></u></td>
            <td><?php echo e($v->pid); ?></td>
            <td><?php echo e($v->path); ?></td>
            <td class="td-manage">
            <a title="编辑" onclick="member_edit('编辑','/admin/coupontype/<?php echo e($v->id); ?>/edit','4','','300')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      $.post("/admin/coupontype/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
