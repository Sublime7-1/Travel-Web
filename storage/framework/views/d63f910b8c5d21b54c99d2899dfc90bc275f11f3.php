...
<?php $__env->startSection('title','密码设置'); ?>
...
<!--主体内容开始--> 
<div class="mainDiv"> 
   	<input id="id" type="hidden" value="<?php echo e(session('userid')); ?>" name="id" /> 
    ...
    function check_oldpwd() {	
	    ...
	    $.post('/home/personalpass/checkpass',{'id':id,'old_pwd':old_pwd,'_token':"<?php echo e(csrf_token()); ?>"},function(data){
	    	if(data == 1){
