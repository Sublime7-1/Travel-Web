...
<?php $__env->startSection('title','途牛投诉与建议处理'); ?>
			  ...
			  <div id="J_adModalLayout" class="ad-modal-layout"></div>
                <div id="J_adModal" class="ad-modal ad-modal-in">
                    <div class="ad-center">
                        ...
                        <div class="ad-modal-text">
                            <p class="f1"><?php echo e(session('error')); ?></p>
                        </div>
                    </div>
                </div>  
			  <script>
	        ...
	        <form class="advise-form J_advise-form" action="/home/advices" method="post" id="content" enctype="multipart/form-data">
	            ...
	            <div class="advise-form-item">
	                ...
	                <ul class="advise-types clearfix J_types">
	                    ...
	                    <li name="<?php echo e($v->id); ?>">
	                        <span class="advise-txt"><?php echo e($v->type); ?></span>
	                        <span class="poptip hide">
	                            <i class="icon icon-tri"></i><?php echo e($v->content); ?>
                ...
                <!-- 登录用户 -->
	            <div class="advise-form-item">
                	<input type="text" name="uid" id="uid" value="<?php echo e(session('userid')); ?>" style="display: none;">
                	<span class="tip"><i class="icon"></i><span class="tip-txt"></span></span>
            	</div>
...
<?php echo $__env->make('home.publics.center', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>