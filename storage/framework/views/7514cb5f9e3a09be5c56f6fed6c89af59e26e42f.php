...
<?php $__env->startSection('title','订单'); ?>
            ...
            <div id="order-item-list">
                ...
                <div class="order-item" style="border-bottom:1px solid #b0b0b0;">
                    <div class="item-header">
                        <span class="item-time">下单时间：<?php echo e($v->order_change_time); ?></span>
                        <span class="order-id">订单号：<?php echo e($v->order_num); ?></span>
                    </div>
                        ...
                        <div class="item-desc">
                            ...
                            <p title="[春节]&lt;斯里兰卡-马尔代夫机票+当地8晚10日游&gt;双国体验 上海直飞 2人即发 0自费 马代可升级岛屿 锡兰网红火车  趣享大礼包">
                                <a href="http://www.tuniu.com/tour/210137709" target="_blank">
                                    <span><?php echo e($v->goods_id); ?>...</span></a>
                            </p>
                        </div>
                        <div class="item-kind"><?php echo e($v->order_type); ?></div>
                        <div class="item-mount"><?php echo e($v->adult_num + $v->child_num); ?>人</div>
                        <div class="item-time">
                            <p><?php echo e($v->begin_time); ?></p>
                        </div>
                        <div class="item-price">
                            <span style="color: #404040">-</span>
                        </div>
                        <div class="item-statue">
                            <?php if($v->order_status == '支付中'): ?>
                                <form action="/home/personal/index/pay/<?php echo e($v->id); ?>" method="post">
                            ...
                            <?php elseif($v->order_status == '支付成功'): ?>
                            ...
                            <?php else: ?>
                                 ...
                                 <p><?php echo e($v->order_status); ?></p>
                            <?php endif; ?>
                           
                            <p>
                                <a target="_blank" href="/home/personal/index/info/<?php echo e($v->id); ?>">订单详情</a></p>
                        </div>
                        <?php if($v->order_status == '支付取消'): ?>
                        <div class="item-operate">
                            <a class="btn del" href="javascript:;" onclick="member_del(this,<?php echo e($v->id); ?>)" data="1078027111">删除</a>
                        </div>
                        <?php endif; ?>
                        <?php if($v->order_status == '支付成功'): ?>
                            <div class="item-operate">
                                <a class="btn del" href="javascript:;" onclick="member_return(this,<?php echo e($v->id); ?>)" data="1078027111">申请退款</a>
                            </div>
                        <?php endif; ?>
                        <?php if($v->order_status == '申请退款'): ?>
                            <div class="item-operate">
                                <a class="btn del" href="javascript:;"  data="1078027111">退款中</a>
                            </div>
                        <?php endif; ?>
                        <?php if($v->order_status == '出游归来'): ?>
                             <a class="btn dian"   href="/home/comment?id=<?php echo e($v->id); ?>" style="" data="1078027111">去点评</a>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div style="margin:0 auto;text-align:center" id="list"><?php echo e($order->links()); ?></div>
            </div>
