   ...
   <div id="Member_Ratings"> 
    <div class="d_Confirm_Order_style"> 
     ...
     <div class="border clearfix"> 
      <button class="btn btn-success">查看商品旅程时间</button>
      ...
      <table class="table table-striped table-bordered table-hover" id="sample-table"> 
       <thead> 
        <tr> 
         ...
         <th width="120">优惠值(<b style="color: black"> 元</b> )</th> 
         <th width="80">发售数量(<b style="color: black"> 元</b> )</th> 
         <th width="160">状态</th> 
         <th width="300">日程描述内容</th> 
         <th width="140">操作</th> 
        </tr> 
       </thead> 
       <tbody>
       <?php $__currentLoopData = $begin_time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        <tr> 
        
         <td><label><input type="checkbox" class="ace" /><span class="lbl"></span></label></td> 
         <td><?php echo e($v->goods_id); ?></td> 
         <td><?php echo e($v->begin_time); ?></td> 
         <td><?php echo e($v->end_time); ?></td> 
         <td><?php echo e($v->percent); ?></td> 
         <td><?php echo e($v->num); ?></td> 
         <?php if($v->status == '售卖'): ?>
          <td id="shou"><button class="btn btn-success" onclick="shou(0)"><?php echo e($v->status); ?></button></td>
         <?php else: ?>
          <td id="shou"><button class="btn btn-default" onclick="shou(1)"><?php echo e($v->status); ?></button></td>
         <?php endif; ?>
        
         <td><?php echo $content[$k]->content; ?></td>   
       	 <td>
          <a title="编辑" href="/admin/goodsinfo/travel/<?php echo e($begin_id[$k]['goods_id']); ?>" class="btn btn-xs btn-info"><i class="icon-edit  bigger-120"></i></a> 
       ...
       <div style="margin:0 auto;text-align:center" id="list"><?php echo e($begin_time->links()); ?></div>
      </table> 
    </div> 
    </div> 
   </div> 
