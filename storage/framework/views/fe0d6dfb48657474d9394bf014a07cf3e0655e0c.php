...
<?php if(count($errors) > 0): ?>
        ...
        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <script>layer.msg('<?php echo e($error); ?>',{icon:5,time:2000});</script>
  ...
  <div class="administrator">
    ...
    <!--操作-->
     <div class="border clearfix">
       ...
       <span class="r_f">共：<b><?php echo e($count); ?></b>人</span>
     </div>
     <!--管理员列表-->
      ...
      <div id="scrollsidebar" class="left_Treeview">
        ...
        <div class="widget-box side_content" >
         ...
         <div class="widget-body">
           ...
           <li><i class="fa fa-users green"></i> <a href="/admin/admin">全部管理员（<?php echo e($count); ?>）</a></li>
            <li><i class="fa fa-users orange"></i> <a href="/admin/admin?status=3">超级管理员（<?php echo e($d_count); ?>）</a></li>
            <li><i class="fa fa-users orange"></i> <a href="/admin/admin?status=2">普通管理员（<?php echo e($c_count); ?>）</a></li>
            <li><i class="fa fa-users orange"></i> <a href="/admin/admin?status=1">编辑管理员（<?php echo e($b_count); ?>）</a></li>
            <li><i class="fa fa-users orange"></i> <a href="/admin/admin?status=0">客服管理员（<?php echo e($a_count); ?>）</a></li>
           </ul>
        </div>
       </div>
      </div>  
...
function member_del(obj,id){
    ...
    layer.confirm('确认要删除吗？',function(index){
        $.post("<?php echo e(url('admin/admin')); ?>/"+id,{"_token": "<?php echo e(csrf_token()); ?>","_method":"DELETE"},function(data){
            if(data == 1){
...
<script>
    ...
    function delAll(){
        ...
        $.get("<?php echo e(url('admin/style/admin/delAll')); ?>",{str:str},function(data){
            console.log(data);
            if(data == 1){
