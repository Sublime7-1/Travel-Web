 ...
 <div id="system_style">
    ...
    <div class="system_logs">
       ...
       <thead>
        ...
        <tbody>
        <tr>
        <?php $__currentLoopData = $system; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <td><?php echo e($value->id); ?></td>
         <td><?php echo e($value->admin_id); ?></td>
         <td><?php echo e($value->admin_level); ?></td>
        ...
        <div style="margin:0 auto;text-align:center" id="list"><?php echo e($system->appends($request)->links()); ?></div>
    </div>
 </div>
</div>
</body>
