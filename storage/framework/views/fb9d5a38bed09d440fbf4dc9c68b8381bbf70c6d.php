...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="/style/admin/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script src="/style/admin/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="/style/admin/assets/js/jquery.ui.touch-punch.min.js"></script>
 ...
 <div class="stystems_style">
  <div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <form action="/admin/system_set" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>网站名称： </label>
            <div class="col-sm-9"><input type="text" id="website-title" placeholder="控制在25个字、50个字节以内" value="<?php echo e($info->name); ?>" name="name" class="col-xs-10 "></div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i> </label>
            <div class="col-sm-9">
                <img width="50" height="50" src="/uploads/<?php echo e($info->pic); ?>"  />
            </div>
        </div>
           <div class="form-group">
           <label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>网站icon图标： </label>
          ...
          <div class="col-sm-9"><input type="text" id="website-title" placeholder="5个左右,8汉字以内,用英文,隔开" value="<?php echo e($info->keywords); ?>" name="keywords" class="col-xs-10 "></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>描述： </label>
          <div class="col-sm-9"><input type="text" id="website-title" placeholder="空制在80个汉字，160个字符以内" value="<?php echo e($info->desc); ?>" name="desc" class="col-xs-10"></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>底部版权信息： </label>
          <div class="col-sm-9"><input type="text" id="website-title" placeholder="" name="copyright" value="<?php echo e($info->copyright); ?>" class="col-xs-10 "></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>备案号： </label>
          <div class="col-sm-9"><input type="text" id="website-title" placeholder="" value="<?php echo e($info->record); ?>" name="record" class="col-xs-10 "></div>
          </div>
