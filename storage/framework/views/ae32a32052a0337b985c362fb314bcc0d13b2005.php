...
<div class="clearfix">
  ...
  <div class="search_style">
   ...
   <tr>
     ...
     <td class="td-status"><span class="label label-success radius"><?php echo e($v->order_status); ?></span></td>
     <td>
     <?php if($v->order_status == '待处理'): ?>
     <a onClick="loading(this,<?php echo e($v->id); ?>,1)"  href="javascript:;" title="待处理"  class="btn btn-xs btn-success"><i class="fa fa-cubes bigger-120"></i></a> 
     <?php elseif($v->order_status == '支付中'): ?>
      <a onClick="del(this,<?php echo e($v->id); ?>,3)"  href="javascript:;" title="取消支付"  class="btn btn-xs btn-danger"><i class="fa fa-close bigger-120"></i></a> 
     <?php endif; ?>
     <a title="订单详细"  href="/admin/order/form/<?php echo e($v->id); ?>"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a> 
     <a title="删除" href="javascript:;"  onclick="Order_form_del(this,<?php echo e($v->id); ?>)" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>    
     </td>
     </tr>
    ...
    layer.confirm('确认用户进行支付吗?',function(){
        $.get('/admin/order/loading_order/status',{'id':id,'i':i},function(data){
            if(data == 1){
                ...
                $(obj).before('<a onClick="del(this,<?php echo e($v->id); ?>,3)"  href="javascript:;" title="取消支付"  class="btn btn-xs btn-danger"><i class="fa fa-close bigger-120"></i></a> ');
                $(obj).remove();
