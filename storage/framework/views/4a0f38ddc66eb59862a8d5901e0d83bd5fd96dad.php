         ...
         <div class="side_list">
            ...
            <div class="widget-body">
               <ul class="b_P_Sort_list">
                   <li><i class="orange  fa fa-list "></i><a href="/admin/article">全部(<?php echo e($total); ?>)</a></li>
                   ...
                   <li><i class="fa fa-newspaper-o pink "></i> <a onclick="mem_type('<?php echo e($v->id); ?>')" href="javascript:;"><?php echo e($v->name); ?>( <?php echo e($v->total); ?> )</a></li>
