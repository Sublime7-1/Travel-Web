 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
      <form action="/admin/coupon" method="post">
       ...
       <ul>
        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>管理员 :</label><span class="formControls col-10"><input type="text" title="管理员" value="<?php echo e($admininfo->name); ?>" id="form-field-1" readonly class="col-xs-10 col-sm-1"></span>
        </li>
        <input type="hidden" name="aid" value="<?php echo e($admininfo->id); ?>">

        <li class="clearfix cates"><label class="label_name"><i>*</i>商品分类 :</label>
          <span class="formControls col-4" id="aiya">
          <select class="form-control chang" id="sid" title="商品分类" style="width:38%;display: inline-block;">
            <option value="" class="ss">--请选择--</option>
          </select>
         </span>
        </li>

        <li class="clearfix cates" id="goods" style="display: none;">
          <label class="label_name"><i>*</i>商品 :</label>
          <span class="formControls col-4" id="aiya">
          <select class="form-control" id="gid" title="商品" name="gid">
            <option value="" class="sss">--请选择--</option>
          </select>
         </span>
        </li>
        ...
        <li class="clearfix Mandatory money"><label class="label_name"><i>*</i>券面值 :</label><span class="formControls col-10"><input type="text" title="券面值" name="money" id="form-field-1" required class="col-xs-1"><b>&nbsp;元</b></span></li>

        <li class="clearfix Mandatory money"><label class="label_name"><i>*</i>满足金额 :</label><span class="formControls col-10"><input type="text" title="满足金额" name="max_money" id="form-field-1" required class="col-xs-1"><b>&nbsp;元</b></span></li>

        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>券描述 :</label><span class="formControls col-10"><input type="text" title="劵描述" name="desc" required placeholder=" 请输入20字以内的描述..." maxlength="20" id="form-field-1" required class="col-xs-10 col-sm-3"></span></li>
        ...
        <li class="clearfix"><label class="label_name"><i>*</i>显示时间 :</label>
         ...
         <label><input type="radio" class="ace" onclick="closes()"><span class="lbl">不显示</span></label></span>
          ...
          <input type="text" autocomplete="off" name="start_time" class="laydate-icon" id="start" style="width:200px; margin-left:10px; padding-left:5px; margin-right:10px; display:block; float:left"></input>
          <em style="display:block; float:left;margin-right:10px;">至</em>
          <input type="text" autocomplete="off" name="end_time" class="laydate-icon" id="end" style="width:200px; padding-left:5px; display:block ;float:left"></input>
          </span>
          <b  style=" margin-left:10px; font-weight:normal; color:#F63">注：(该时间用于设置优惠劵是否可以使用的时间段，过了最后的时间段则该优惠劵将失效，无需再次操作，适合活动使用)</b>
         </span>
        </li>
        <li class="clearfix Mandatory">
        <label class="label_name"><i>*</i>活动标题 :</label><span class="formControls col-10"><input name="title" type="text" id="form-field-1" title="活动标题" class="col-xs-10 col-sm-5 " placeholder=" 请输入30字以内的标题..." maxlength="30"></span>
        </li>
        <li class="clearfix"><label class="label_name"><i>*</i>活动规则 :</label>
        <span class="formControls col-10"><script id="editor" name="content" type="text/plain" style="width:80%;height:300px; margin-left:10px;"></script> </span>
        </li>
       </ul>
