...
<div class="margin clearfix">
 ...
 <div class="border clearfix">
   ...
   <tr>
     ...
     <td>
     <a onClick="Delivery_Refund(this,{{$v->id}},5)"  href="javascript:;" title="退款"  class="btn btn-xs btn-success">退款</a> 
     <a title="退款订单详细"  href="/admin/order/form/{{$v->id}}"  class="btn btn-xs btn-info Refund_detailed" >详细</a> 
