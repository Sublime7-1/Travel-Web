     ...
     <div class="table_menu_list container"> 
        ...
        <div class="form-group">
            ...
            <div class="formControls">
                <script id="editor" type="text/plain" name="content" readonly style="width:1000px;height:400px;">{{$data->reply}}</script>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
        <div class="form-group">
            ...
            <div class="formControls">
                <input type="text" class="input-text" id="user-name" value="{{$data->reply_time}}" readonly style="margin-left: 0;width: 500px;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
