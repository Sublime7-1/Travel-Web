...
<div class=" page-content clearfix">
 <div id="products_style">
    <div class="search_style">
     <form action="/admin/NavigateFirst/{{$pid}}" method="get">
      <ul class="search_content clearfix">
       <li><label class="l_f">产品名称</label><input name="keyword" value="{{$keyword or ''}}" type="text"  class="text_add" placeholder="输入品牌名称"  style=" width:250px"/></li>
     ...
     <div class="border clearfix">
       ...
       <span class="r_f">共：<b>{{$num}}</b>个子分类</span>
     </div>
    ...
    @foreach($data as $v)
     <tr>
        ...
        <td width="100px">
            @if($v->pic)
            <img src="../{{$v->pic}}" alt="{{$v->name}}"  name="pic" />
            @else
            无
            @endif
        </td>
