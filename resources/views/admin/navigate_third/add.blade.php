...
<div class="type_style">
  ...
  <form action="/admin/NavigateThird" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix" style="text-align: center;">
