 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <button onclick="member_open1({{$pid}})" title="添加分类" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加分类</button>
    ...
    @foreach($data as $v)
     <tr>
        ...
        <td width="250px">{{$v->pid}}</td>
        <td class="td-manage">
            <a title="编辑" onclick="member_open2({{$v->id}})" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
function member_open2(id){
    $.get('/admin/NavigateThird/'+id+'/edit',{'childlist':1},function(data){
        layer.open({
            type:1,
            title:'修改分类',
            area:['600px','300px'],
