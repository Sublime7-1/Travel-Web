            ...
            <div id="products_style">
                ...
                <div class="table_menu_list" id="testIframe">
                    <table class="table table-striped table-bordered table-hover" id="sample-table">
                        ...
                        <tbody>
                            @foreach($top_cates as $top_cates_v)
                            <tr>
                                <td width="25px">
                                    <label>
                                        <input type="checkbox" class="ace">
                                ...
                                <td width="250px">{{$top_cates_v->name}}</td>
                                <td class="td-manage">
                                    <a title="编辑" onclick="member_open1({{$top_cates_v->id}})" href="javascript:;" class="btn btn-xs btn-info">添加子分类</a></td>
                                <td class="td-manage">
                                    <a title="编辑" href="/admin/NavigateThird/{{$top_cates_v->id}}" class="btn btn-xs btn-info">查看子分类</a></td>
                                <td class="td-manage">
                                    <a title="编辑" onclick="member_open2({{$top_cates_v->id}})" href="javascript:;" class="btn btn-xs btn-info">
                                        <i class="icon-edit bigger-120"></i>
                                    </a>
                                    <a title="删除" href="javascript:;" onclick="member_del(this,{{$top_cates_v->id}})" class="btn btn-xs btn-warning">
...
function member_del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      $.post("/admin/NavigateThird/"+id,{"_token": "{{ csrf_token() }}","_method":"DELETE"},function(data){
            if(data == 1){
