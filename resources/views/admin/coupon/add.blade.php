 ...
 <div class="article_style">
    <div class="add_content" id="form-article-add">
      <form action="/admin/coupon" method="post">
        {{csrf_field()}}
       <ul>
        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>管理员 :</label><span class="formControls col-10"><input type="text" title="管理员" value="{{$admininfo->name}}" id="form-field-1" readonly class="col-xs-10 col-sm-1"></span>
        </li>
        <input type="hidden" name="aid" value="{{$admininfo->id}}">
