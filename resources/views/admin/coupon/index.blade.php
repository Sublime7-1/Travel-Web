     ...
     <div class="search_style"> 
      <form action="/admin/coupon/indexs" method="get">
        ...
        <ul class="search_content clearfix"> 
         <li><label class="l_f">优惠券面值 :</label><input name="money" type="text" class="text_add" placeholder="  输入数字..." value="{{$request->money or ''}}" style=" width:200px;height: 36px" /></li> 
      ...
      <table class="table table-striped table-bordered table-hover" id="sample-table"> 
       ...
       @foreach($data as $v) 
        <tr> 
         ...
         <td>{!!$v->content!!}</td>   
       	 <td>
          <a title="编辑" href="/admin/coupon/{{$v->id}}/edit" class="btn btn-xs btn-info"><i class="icon-edit  bigger-120"></i></a> 
