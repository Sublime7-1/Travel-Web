...
<html lang="en">
 <head> 
  ...
  <link rel="icon" href="/uploads/{{$info->pic}}" type="image/x-icon"  />
  <!--[if lte IE 8]>
...
function link_operating(name,title){
 ...
 <body> 
   ...
   <div class="navbar-container" id="navbar-container"> 
    ...
    <div class="navbar-header pull-right" role="navigation"> 
     <ul class="nav ace-nav"> 
      <li class="light-blue"> <a data-toggle="dropdown" href="#" class="dropdown-toggle"> <span class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>{{$level}}</span> <i class="icon-caret-down"></i> </a> 
      ...
      <li class="purple"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-bell-alt"></i><span class="badge badge-important">{{$real_num + $num1}}</span></a> 
       <ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close"> 
        <li class="dropdown-header"><i class="icon-warning-sign"></i>{{$real_num + $num1}}条通知</li> 
        <li> <a href="#" onclick="news()"> 
          <div class="clearfix"> 
           <span class="pull-left"> <i class="btn btn-xs no-hover btn-pink icon-comments-alt"></i> 最新消息 </span> 
           <span class="badge badge-danger dingdanreal">{{$real_num + $num1}}</span>
          </div> </a> </li> 
        ...
        <li> <a href="#" onclick="dingdan()"> 
          <div class="clearfix"> 
           ...
           <span class="badge badge-danger dingdanreal">{{$real_num}}</span>
          </div> </a> </li> 
        <li> <a href="#" onclick="yonghu()"> 
          <div class="clearfix"> 
           <span class="pull-left"> <i class="btn btn-xs no-hover btn-info icon-twitter"></i> 用户消息 </span> 
           <span class="badge badge-danger servicenews">{{$num1}}</span>
          </div> </a> </li> 
    ...
    <div class="sidebar" id="sidebar"> 
     ...
     <div id="menu_style" class="menu_style"> 
      <ul class="nav nav-list" id="nav_list"> 
       ...
       <li> <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 订单管理<span class="badge badge-danger dingdanall ">{{$sum}}</span> </span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
        <li class="home"><a href="javascript:void(0)" name="/admin/order/success_order" title="完成的订单" class="iframeurl"><i class="icon-double-angle-right"></i>完成的订单</a></li> 
         <li class="home"><a href="javascript:void(0)" id="dingdan" name="/admin/order/loading_order" title="交易信息" class="iframeurl"><i class="icon-double-angle-right"></i>待处理<span class="badge badge-danger dingdanreal">{{$real_num}}</span></a></li> 
         <li class="home"><a href="javascript:void(0)" name="/admin/order/return" title="退款管理" class="iframeurl"><i class="icon-double-angle-right"></i>退款管理<span class="badge badge-danger dingdanreturn">{{$return_num}}</span></a></li> 
       ...
       <li> <a href="#" class="dropdown-toggle"><i class="icon-sun"></i><span class="menu-text"> 友情链接管理<span class="badge badge-danger linksnum">{{$links_num}}</span> </span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
         <li class="home"><a href="javascript:void(0)" name="/admin/links" title="友情链接列表" class="iframeurl"><i class="icon-double-angle-right"></i>友情链接列表<span class="badge badge-danger linksnum">{{$links_num}}</span></a></li> 
       ...
       <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 客服管理<span class="badge badge-danger servicenum">{{$service_num}}</span> </span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
         ...
         <li class="home"><a href="javascript:void(0)" name="admin/servicesend" title="店铺审核" class="iframeurl"><i class="icon-double-angle-right"></i>客服审核<span class="badge badge-danger servicenum">{{$service_num}}</span></a></li> 
        </ul> </li> 
        ...
        <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 聊天室 <span class="badge badge-danger servicenews">{{$num1}}</span> </span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
         <li class="home"><a href="javascript:void(0)" id="yong" name="/admin/servicenews" title="用户消息" class="iframeurl"><i class="icon-double-angle-right"></i>用户消息<span class="badge badge-danger servicenews">{{$num1}}</span> </a></li> 
        </ul> </li>


        <li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 站内信管理 <span class="badge badge-danger message">{{$message_num}}</span></span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
         <li class="home"><a href="javascript:void(0)" name="/admin/message" title="消息列表" class="iframeurl"><i class="icon-double-angle-right"></i>已发消息<span class="badge badge-danger message">{{$message_num}}</span></a></li> 
       ...
       <li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 意见反馈管理 <span class="badge badge-danger advicesnum">{{$advices_num}}</span></span><b class="arrow icon-angle-down"></b></a> 
        <ul class="submenu"> 
         ...
         <li class="home"><a href="javascript:void(0)" name="/admin/advices" title="意见列表" class="iframeurl"><i class="icon-double-angle-right"></i>意见列表<span class="badge badge-danger advicesnum">{{$advices_num}}</span></a></li> 
        </ul> </li> 
  ...
  <div class="footer_style" id="footerstyle"> 
   ...
   <p class="l_f">版权所有：{{$info->copyright}}</p> 
   <p class="r_f">地址：{{$info->record}} 更多模板：<a href="http://www.mycodes.net/" target="_blank">源码之家</a></p> 
  </div> 
  <!--修改密码样式--> 
