      ...
      <form action="/admin/discountActive" method="post" id="typeerror">
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 500px">
                <input type="text" class="input-text" value="{{old('name')}}" placeholder="   请输入30字内的内容" id="user-name" name="name"  style="margin-left: 0;width: 500px;height: 40px">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="formControls">
               <select name="goods_id" id="">
                 ...
                 <option value="{{$goods_v->id}}">{{$goods_v->title}}</option>
                 @endforeach
               </select>
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        ...
        <div class="form-group">
            ...
            <div class="formControls" style="width: 400px;">
                <input type="text" class="input-text" placeholder="   请输入优惠金额" id="user-name" name="discount_amount" value="{{old('discount_amount')}}" style="margin-left: 0;height: 40px">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div>
        <div class="form-group">
            ...
            <div class="formControls" style="width: 400px;">
                <input type="date" name="begin_time" value="{{old('begin_time')}}" style="margin-left: 0px;">&nbsp;&nbsp;-<input type="date" name="end_time" value="{{old('end_time')}}">
            </div>
            <div class="col-4"> <span class="Validform_checktip"></span></div>
        </div> 
         <div class="form-group">
