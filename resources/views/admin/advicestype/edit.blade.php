<div class="type_style">
 <div class="type_title">修改广告信息</div>
  ...
  <form action="/admin/advicestype/{{$data->id}}" method="post" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>分类名：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="{{$data->type}}" required placeholder="" id="user-name" name="type">
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>显示内容：</label>
      <div class="formControls ">
        <textarea cols="6" rows="3" required name="content">{{$data->content}}</textarea>
        <!-- <input type="text" required class="input-text" name="content" value="{{$data->content}}" placeholder="" id="user-name"> -->
      </div>
    </div>
    <div class="">
