  ...
  <div class="sort_list">
	...
	<tbody>
      ...
      <tr>
       ...
       <td class="td-manage">
         <a title="添加"  href="javascript:;" value="{{$v->id}}" class="btn btn-xs btn-warning son_add" >添加子分类</a>   
       </td>
       <td class="td-manage">
         <a title="查看" href="/admin/adverttype/check/{{$v->id}}"  class="btn btn-xs btn-info" >查看子分类</a>   
       </td>
