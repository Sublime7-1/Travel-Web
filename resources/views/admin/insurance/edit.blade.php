...
<div class="type_style">
 <div class="type_title"></div>
  ...
  <form action="/admin/insurance/{{$data->id}}" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-user-add">
    <div class="Operate_cont clearfix">
     ...
     <div class="Operate_cont clearfix">
      ...
      <div class="formControls " style="padding-left: 10px;">
        <input type="radio" class="input-text" value="1" @if($data->type==1) checked @endif  id="user-name" name="type">&nbsp;意外险&nbsp;
        <input type="radio" class="input-text" value="2" @if($data->type==2) checked @endif  id="user-name" name="type">&nbsp;取消险&nbsp;
      </div>
    </div>
    <div class="Operate_cont clearfix">
      <label class="form-label"><span class="c-red">*</span>保险金额：</label>
      <div class="formControls ">
        <input type="text" class="input-text" value="{{$data->money}}" placeholder="" id="user-name" name="money">
      </div>
    </div>
    <div class="">
