	 ...
	 <div id="login-box" class="login-box widget-box no-border visible"> 
	  <div class="widget-body"> 
       ...
       @if(!empty($error))
		...
		<form  action="{{url('admin/dologin')}}" method="post" id="codeform"> 
		 <fieldset> 
          ...
          @if (count($errors) > 0)
            ...
            @endif
		   <li class="frame_style form_error"><label class="user_icon"></label><input name="name" type="text" id="username" placeholder="用户名" value="{{old('name')}}"/><i></i></li> 
		   ...
		   <li class="frame_style form_error"><label class="Codes_icon"></label><input name="code" type="text" placeholder="验证码" id="Codes_text" value="" /><i></i>
			...
			<div class="Codes_region"><img style="width:100px;height:100%" src="{{url('/system/code')}}" onclick="this.src='{{url('/system/code')}}?'+Math.random()"></div></li> 
		  </ul> 
		  <div class="space"></div> 
		  <div class="clearfix"> 
