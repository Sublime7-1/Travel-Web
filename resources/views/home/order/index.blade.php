...
<html>
    ...
    <body class="step1 tour_order2" id="m-step1">
        <div class="m-container" id="m-container">
            ...
            <!-- 提交form表单 -->
            <form action="/home/order/order_two/{{$goods_id}}" id="orderinfo_form" onsubmit="return checkForm(this)" method="post">
            <!-- 主体部分 -->
            <div class="g-wrapper">
                                ...
                                <div class="book-tourist-main">
                                    <div class="row">
                                        <div class="field field-width J_departCity">
                                            ...
                                            <div class="input_select w_200 ">
                                                <ul class="s_clist">
                                                    <li citycode="2500" title="上海">{{$city->begin_city}}</li></ul>
                                                <div class="s_cnum s_cnum_onlyone">
                                                    <p class="s_ccon" citycode="2500">{{$city->begin_city}}</p></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input_select w_350">
                                            <select class="s_cnum " name="time" style="width:282px">
                                                <span class="sc_arrow"></span>
                                                    <option class="f-ol s_ccon" title="12-12 周三出发--12-21 周五返回" departdate="2018-12-12" adultprice="15336" childprice=" 14271 " value="{{$time_id}}" roomaddbudget="">{{$arr_time[0]}}  周{{$num[$firstweek]}}出发-- {{$arr_time[1]}} 周{{$num[$secondweek]}}返回
                                                    </option>
                                                    @if($begin_time)
                                                    ...
                                                    <?php 
                                                     ...
                                                     ?>
                                                    <option class="f-ol s_ccon" title="12-12 周三出发--12-21 周五返回" departdate="2018-12-12" adultprice="15336" childprice=" 14271 " roomaddbudget="" value="{{$v->id}}">{{$v->begin_time}} 周{{$num[$first]}}出发-- {{$v->end_time}} 周{{$num[$second]}}返回
                                                    </option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                    ...
                                    <div class="field J_touristCount">
                                        ...
                                        <div class="input_number J_adultCount">
                                            ...
                                            <input type="text" id="adult_num" name="adult_num" class="value" readonly="readonly" value="{{$adult_num}}">
                                        ...
                                        <div class="input_number J_childCount">
                                            ...
                                            <input type="text" id="child_num" name="child_num" class="value" readonly="readonly" value="{{$child_num}}" onclick="jian(this)">
                    ...
                    <div class="modular m-multi-transport" id="m-multi-transport" style="opacity: 1; display: block;">
                        <h2>
                            ...
                            <span class="T_city_panel T_departure_city">
                                <span class="T_name">{{$city->begin_city}}</span>
                                    ...
                                    <div class="tran_journey " id="change">
                                        <table class="tran_info">
                                            <tbody>
                                                <tr>
                                                    <td class="route">
                                                        <div class="trip f-ol" title="南京-上海">{{$v->begin_city}}-{{$v->end_city}}</div>
                                                        <div class="time">2018-12-11</div></td>
                                                    <td class="flight">
                                                        <div class="company f-ol" title="{{$v->city_name}}">
                                                            <i class="airplane-company-icon airport_MU"></i>{{$v->city_name}}</div>
                                                        <div class="number">
                                                            <span class="flightNo f-ol " title="MU2881 320(中)">{{$v->englishname}}(中)</span></div>
                                                    </td>
                                                    <td class="stop">
                                                        <div class="where f-ol" title="{{$v->begin_fei}}">{{$v->begin_fei}}</div>
                                                        <div class="when">{{date('H:i',strtotime($v->begin_city_time))}}</div></td>
                                                    <td class="arrow">
                                                        <div>
                                                            ...
                                                            $arr = explode('/',$v->end_city_time);
                                                                $end = array_pop($arr);
                                                             ?>
                                                            {{$end-$begin}}小时</span></div>
                                                    </td>
                                                    <td class="stop">
                                                        <div class="where f-ol" title="浦东国际机场">{{$v->end_city}}</div>
                                                        <div class="when">08:25</div></td>
                                                    <td class="level">{{$v->type}}
                                        ...
                                        <label class="input_checkbox change " data-index="0">
                                            <input type="checkbox" {{$k == 0 ? 'checked':''}} name="goods_city" onclick="change(this)" biaoji = "b" style="    width: 17px; height: 17px;" value="{{$v->id}}" /></label>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="modular m-insurance" id="m-insurance" style="display: block; opacity: 1;">
                        ...
                        <div class="modular-body">
                            ...
                            <div class="panel  has-border">
                                <span class="type" style="">{{$v->type}}</span>
                                <span class="name f-ol">
                                    <em class="f-active-color detail-wrapper" title="{{$v->name}}">{{$v->name}}</em>
                                </span>
                                <span class="price">
                                    <em>￥{{$v->money}}</em>/人</span>
                                <span class="select-box">
                                    <label class="input_checkbox enabled">
                                        <input type="checkbox" {{$k == 0 ? 'checked':''}} value="{{$v->id}}" style="width:17px;height:17px" name="insurance"  onclick="change1(this)" class="tn_fontface">
                                    </label>
                                </span>
                            </div>
                            @endforeach
                    ...
                    <div class="modular m-favourable" id="m-favourable" style="opacity: 1; display: block;">
                        ...
                        <div class="modular-body">
                            <ul class="list J_list">
                                @if($couponinfo[0] != null )
                                 @foreach($coupon as $k=>$v)
                                <li class="list_row no-border ">
                                  
                                    <span class="col1">{{$couponinfo[$k]->name}}</span>
                                   
                                    

                                    <span class="col2">
                                        <span class="detail-wrapper f-active-color ">{{$couponinfo[$k]->title}}
                                    ...
                                    <span class="col3">-￥{{$couponinfo[$k]->money}}</span>
                                    <span class="col4">
                                        <label class="input_checkbox   ">
                                            <input type="checkbox" {{$k == 0 ? 'checked':''}} name="coupon" onclick="change2(this)" style="width:17px;height:17px" value="{{$v->cid}}" class="tn_fontface fontface1"></label>
                                    </span>
                                ...
                                <li class="list_row  ">
                                    ...
                                    <span class="col3">-￥{{$v->discount_amount}}</span>
                                    <span class="col4">
                                        <label class="input_checkbox  fontinfo1">
                                             <input type="checkbox" {{$k == 0 ? 'checked':''}} name="discount" onclick="change3(this)" style="width:17px;height:17px" value="{{$v->id}}" class="tn_fontface fontface2"></label>
                                    </span>
                                </li>
                            ...
                            <div class="panel">
                                <div class="panel-group name">
                                    ...
                                    <div class="panel-body">
                                        <input type="text" name="username" class="field-input input-name" placeholder="如：张三" value="{{$username}}"></div>
                                </div>
                                <div class="panel-group tel mobile">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input type="text" name="userphone" class="field-input input-tel" value="{{$userinfo->tel}}"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="fr-panel">
                                            ...
                                            <div class="field J_birth_date">
                                                ...
                                                <select class="field_select_date " data-year="" name="form_burn_date1[]">
                                                    @for($i = 1920;$i<2016;$i++)
                                                    <option {{$i == 1996 ? 'selected' :''}}>{{$i}}</option>
                                                    @endfor
                    ...
                    <div class="price-infor">
                                    ...
                                    <div class="T_slide" style="top: 0px; padding-right: 10px;">
                                        <div class="panel" style="    padding: 20px 26px;">
                                            <p class="price-detail-title">
                                                ...
                                                <span class="main">￥{{(($goodsinfo->price * $time_money) * 0.8 * $child_num) + (($goodsinfo->price*$time_money) * $adult_num) }}</span></p>
                                            <p class="price-detail">成人{{$goodsinfo->price}}x{{$adult_num}}</p>
                                             <p class="price-detail">儿童  8折 {{($goodsinfo->price * $time_money) *0.8}}x{{$child_num}} </p>
                                            </div>
                                        <div class="panel" style="    padding: 20px 26px;">
                                            <p class="price-detail-title">
                                                <span class="title">保险费用</span>
                                                <span class="main">￥{{$insurancefirst->money * $outing}}</span></p>
                                            <p class="price-detail">
                                                <span class="subtitle" title="人保财出境游旅意险经典方案（出游8~10天）">{{$insurancefirst->name}}</span>￥{{$insurancefirst->money}}x{{$outing}}</p>
                                            </div>
                                    </div>
                        ...
                        <div class="total-price">
                            <div class="price-wrapepr">总价
                                ...
                                <span class="price">￥{{($insurancefirst->money * $outing) + ((($goodsinfo->price * $time_money) * 0.8 * $child_num) + (($goodsinfo->price * $time_money) * $adult_num) )}}</span>
                                <div class="clear-float"></div>
                            </div>
                            <span class="payments">（
                                <span class="stages-price total-price-hover">首付￥{{($insurancefirst->money * $outing) + (($goodsinfo->price * 0.8 * $child_num) + ($goodsinfo->price * $adult_num) )}}×24期，4种分期可选
                                    <div class="total-price-detail2 T_width2">
                                        <p class="tips">可选期数(4种分期)</p>
                                        <div class="panel ">
                                            <div class="main panel-left">
                                                <span>{{floor((($insurancefirst->money * $outing) + (($goodsinfo->price * 0.8 * $child_num) + ($goodsinfo->price * $adult_num)))/6)}}分6期</span></div>
            ...
            <input type="hidden" name="admin_id" value="{{$goodsinfo->admin_id}}">
            <!-- 页脚 -->
            ...
            <div class="dandude" num="{{$j}}">
                <div class="tourist_info mt20 expanded" data-type="adult">
                    <div class="fl-panel">
                        <div class="top">
                            <input class="field_input touristType" type="hidden">第
                            <span class="num" id="checknum">{{$j}}</span>位</div>
                        <div class="bottom ">成人</div></div>
                    <div class="fr-panel">
                        <div class="field J_name">
                            <label class="field_label">
