    ...
    <div class="header_top">
     <div class="header_inner clearfix">
      <ul class="index_top_nav" id="user_login_info">
       ...
       @if(session('username'))
        <li><span>您好，</span></li>
        <li id="vipnameBox" class="vipname_box"><a href="/home/personal/index" id="vipname" class="vipname" rel="nofollow"><span class="fl" style="float:left;">{{session('username')}}</span><span class="vip vip0"></span> <span class="poparrow"></span></a>
         <div class="colle_box">
