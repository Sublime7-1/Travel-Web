...
<div class="main-content">
    <div class="coupon_header">
        ...
        <div>
            <div class="coupon_info">可用优惠券:<span class="coupon_num">{{$notuse}}</span>张</div>
    ...
    <div class="coupon_floor">
        <div class="coupon_ul_div">
            <ul>
                <li class="coupon_nouse coupon_li li_active">
                    <span class="coupon_span coupon_nouse_span">未使用({{$notuse}})</span>
                </li>
            </ul>
        </div>
        <div class="coupon_type">
            <ul class="coupon_type_ul">
                ...
                <li class="coupon_type_li" data-id="{{$v->id}}">{{$v->name}}</li>
                @endforeach
                <li class="clear"></li>
            </ul>
        </div>
